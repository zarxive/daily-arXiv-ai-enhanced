...
TL;DR: 研究了带隙双层石墨烯器件的电子输运，发现特定边终止情况下出现边态导电，与实验结果吻合，边态导电特性依赖于边终止类型和电子能。


<details>
  <summary>Details</summary>
Motivation: 石墨烯是二维材料领域的重大突破，研究其电子输运特性具有重要意义。

Method: 通过理论模型、模拟和对比实验来验证结果。

Result: 在特定边终止下出现边态导电，与实验一致，且导电性与边终止类型有关且可调节电子能。

Conclusion: 边态导电特性依赖于边终止和电子能，不涉及拓扑边态。
...
TL;DR: 研究设计了一个混合式磁 predicted annealing 能量下降更快，更适合找到全局最优化解。


<details>
  <summary>Details</summary>
Motivation: 磁预测 Annealing 是一种模拟退火的方法，用于优化磁性材料的微结构，以实现最佳能量状态。通过引入铁氧体微球，可以改进磁预测 Annealing 的效果。

Method: 通过在烧结 YBCO 膜上表面均匀分布 FeO−B2 微球，并在热处理后形成有序的球形结构，制备了磁预测 Annealing 样品。使用振动原子磁离子显微镜（vASM）观察微观结构，并结合磁性参数表征和退火过程中的磁性变化分析。

Result: 1. 微球间的磁性 interaction 存在相互排斥，导致磁性退火过程中的能量下降效率增加。2. 微球与基底材料间的磁性 coupling 改善了磁预测 Annealing 的均匀性。3. 微球的有序排列有利于形成一致的磁性结构。

Conclusion: 通过引入铁氧体微球改善磁预测 Annealing，已在实验中取得了成功。该研究为磁性材料的优化提供了新的方法，未来可在其他磁性材料制备中应用此类方法。
...
TL;DR: 该论文讨论了具有反演中心的磁体在无形变情况下由于顺转产生的Dzyaloshinsky-Moriya相互作用，提出了这一相互作用的微观机制，并提供了一种估算常数。研究显示，这种相互作用可以消除螺旋磁性中的共轭Degeneracy，并提出了一种实验观察的方法。


<details>
  <summary>Details</summary>
Motivation: 磁性材料中的相互作用研究一直是材料科学和量子磁性的热门领域，理解tiDMI的来源及其在分裂磁性中的作用具有重要意义。

Method: 理论分析和估计方法，结合了晶体学和磁性理论。

Result: 确定了tiDMI的存在，并挖掘了其与chiral分裂磁性之间的关系，同时提供了实验证实的可能性。

Conclusion: tiDMI通过加速方向性磁性的形成为磁性研究带来了新的视角。
...
### [5] [Dichroism from Thermoelectric Chiral Drives: Generalized Sum Rules for Orbital and Heat Magnetizations](https://arxiv.org/abs/2511.21599)
*Baptiste Bermond,Lucila Peralta Gavensky,Anaïs Defossez,Nathan Goldman*

Main category: cond-mat.mes-hall

TL;DR: We introduce a unified framework analyzing orbital and heat magnetizations through thermoelectric probes and generalized sum rules.


<details>
  <summary>Details</summary>
Motivation: This paper presents a novel framework for understanding the interplay between orbital and heat magnetizations in materials.

Method: The authors utilize thermoelectric probes, generalized sum rules, and analyze zero-temperature transport coefficients with Kramers-Kronig relations.

Result: A hierarchical construction is introduced, organizing magnetizations into distinct physical contributions, accessible through sum rules, and real-space markers for these magnetizations are derived.

Conclusion: This framework establishes thermoelectric dichroic measurements as a versatile tool for probing fundamental ground-state properties in quantum-engineered materials.
...
### [6] [Size optimization for observeing Majorana fermions](https://arxiv.org/abs/2511.21423)
...
### [7] [Enabling the bulk photovoltaic effect in centrosymmetric materials through an external electric field](https://arxiv.org/abs/2511.21458)
*Guilherme J. Inacio,Juan José Esteve-Paredes,Maurício F. C. Martins Quintela,Wendel S. Paz,Juan José Palacios*

Main category: cond-mat.mes-hall

TL;DR: 研究通过在光激发前施加静电横向电场来电性调节二维半导体的非线性光响应，提出了基于Wannier插值哈密顿量的场 dress 方法，成功预测了层状材料中的非线性光电流行为。


<details>
  <summary>Details</summary>
Motivation: 随着二维半导体在光电子学中的广泛应用，理解并调控其光学响应对于开发高效光电子器件至关重要。

Method: 研究通过在光激发前施加外加电场的方法，引入场 dress 技术，AKIWANNEr HamiltonianW改进了局域化及带宽分散特性。

Result: 该方法在莫西耶二层体系中成功捕捉到了有限位移电流的出现，并通过泰勒展开分析了场强对位移导电性的影响机理，揭示了场诱导的高阶非线性光响应现象。

Conclusion: 该研究提供了一种有效且实用的场 dress 方法，为预测和解析层状材料中的非线性光电流提供了理论依据。
...
### [8] [Symmetries of excitons](https://arxiv.org/abs/2511.21540)
*Muralidhar Nalabothula,Davide Sangalli,Fulvio Paleari,Sven Reichardt,Ludger Wirtz*

Main category: cond-mat.mes-hall

TL;DR: 研究利用群论方法分析晶格对激发子态的对称性变换，推导出分类和选择法则及提高计算效率的方法。


<details>
  <summary>Details</summary>
Motivation: 理解晶格对激发子态的影响及其对称性，有助于开发更高效的计算方法。

Method: 采用群论方法，结合BSE求解，分析激发子态的对称性。

Result: 提出了分类激发子态的方法，得出选代规则及对计算效率的提升。

Conclusion: 该框架适用于多种晶体材料，为未来研究激发子态对称性奠定基础。
...
### [9] [Formation of Light-Emitting Defects in Ag-based Memristors](https://arxiv.org/abs/2511.21555)
*Diana Singh,Maciej Ćwierzona,Sebastian Maćkowski,Alexandre Bouhelier*

Main category: cond-mat.mes-hall

TL;DR: The research investigates the light emission mechanisms in Ag-based in-plane memristors, discovering the early stage defects responsible for electroluminescence. The process involves electrical activation and subsequent light emission, which the study uses to explore emission control for memristor integration in neuromorphic circuits.


<details>
  <summary>Details</summary>
Motivation: The paper aims to enhance understanding of memristor mechanisms to improve their functionality in neuromorphic systems.

Method: The researchers combined electrical stimulation with optical measurements, specifically electroluminescence and photoluminescence, to monitor defect behavior during activation.

Result: They identified the early stage defects responsible for light emission and how these evolve with electrical activation.

Conclusion: The findings contribute to controlling light emission in memristors, essential for their application in advanced electronic circuits.
...
### [10] [Phonon-tunable THz magnonic emission in multiferroic heterostructures](https://arxiv.org/abs/2511.21596)
...
TL;DR: Efficient tunable THz sources based on BiFeO3 with phonon-polariton coupling demonstrated.


<details>
  <summary>Details</summary>
Motivation: Understanding and controlling THz generation in multiferroic materials for applications in optoelectronics and sensing.

Method: Used epitaxial BiFeO3 films and Pt layers, likely employing optical rectification with different film thicknesses to tune emission wavelength.

Result: Achieved sub-bandgap THz emission in 0.4-0.8 THz, tunable emission spectrum via modulating Pt layer thickness, and photocatalytic generation of polaritons for wave emission.

Conclusion: Hybrid phonon-polariton systems in BiFeO3 provide versatile THz sources tunable by material and structural properties, opening new avenues in THz technology through multiferroic multilayers.
...
### [11] [Strong-coupling theory of bilayer plasmon excitations](https://arxiv.org/abs/2511.20776)
*Hiroyuki Yamase,Luciano Zinni,Matías Bejas,Andrés Greco*

Main category: cond-mat.str-el

TL;DR: 研究双层晶格系统中的图灵激发，首次提出强耦合理论，结果显示与弱耦合理论中有相似的激发模式，但粒子-空穴激发被显著抑制，可能与实验相符。


<details>
  <summary>Details</summary>
Motivation: 探索强耦合效应对双层系统激发的影响，尤其是对于 cuprates 这样的超导材料，具有重要意义。

Method: 使用 t-J-V 模型，包含长程库仑相互作用的格点系统。

Result: 强耦合理论显示与弱耦合理论中的激发模式相似，但粒子-空穴激发显著抑制，有助于更广泛定义能隙。

Conclusion: 实验结果支持 ω₋ 模式，但需要更多系统实验验证。
...
### [12] [Hund-projected Kanamori model: an effective description of Hund's metals near the Mott insulating regime](https://arxiv.org/abs/2511.20788)
*Johan Carlström*

Main category: cond-mat.str-el

TL;DR: 研究了多轨道系统中的库仑耦合在材料性质中的关键作用，提出了一个可有效描述这类材料的约化模型。


<details>
  <summary>Details</summary>
Motivation: 库仑耦合在磁性材料中的作用，特别是在高自旋状态下的电子自旋研究。

Method: 通过约化多轨道哈ubbard-канамori哈密顿量的方法，导出了更简洁的库仑耦合投影后的模型。

Result: 模型在无掺杂时还原为高自旋磁性Heisenberg模型，在掺杂情况下显示大量磁共性和更强的Nagaoka机制。

Conclusion: 建立了一个连接kanami模型和高自旋材料性质的桥梁，提供了研究这类材料的有效途径。
...
### [13] [Defect Bootstrap: Tight Ground State Bounds in Spontaneous Symmetry Breaking Phases](https://arxiv.org/abs/2511.20860)
...
### [14] [Exploring the Anomalous Nernst Effect in SrRuO$_3$](https://arxiv.org/abs/2511.20962)
*Anna Merin Francis,Avirup De,Abhijit Biswas,Lily Mandal,Pallavi Kushwaha,Sunil Nair*

Main category: cond-mat.str-el

TL;DR: 研究了晶体向附着在铝氧化物基板上的氧化atório内氨基 messed物的异常 nerves 效应，观察到在临界温度 $T_c$ 附近明显的 nerves 响应，这归因于磁场与晶体轴向之间的关系。


<details>
  <summary>Details</summary>
Motivation: 热力性质与磁场和温度的变化密切相关，特别是在高温超导体中。

Method: 通过测量跨温热电响应，研究了温度和磁场对异常 nerves 效应的影响，特别是在 (111) 晶向的单晶氧化物薄膜和块状物中。

Result: 在接近 $T_c$ 的温度下，单晶氧化物薄膜显示出强烈的 nerves 响应，而块状物的现象不同。

Conclusion: 结论是内氨基 mess 的温度依赖性与磁场方向有关，且磁性单轴与电动势的环流密切相关。
...
### [15] [Probing magnetic-field-induced multipolar ordering through field-angle-resolved magnetostriction and thermal expansion in PrIr$_2$Zn$_{20}$](https://arxiv.org/abs/2511.21039)
*Naoki Okamoto,Yohei Kono,Takahiro Onimaru,Keisuke T. Matsumoto,Kazumasa Hattori,Shunichiro Kittaka*

Main category: cond-mat.str-el

TL;DR: 研究中，通过测量PrIr₂Zn₂₀在不同磁场方向下的磁性弹性特性，发现该化合物在零磁场时存在A型相，在磁场沿[001]方向时表现出剧烈的热膨胀异常，支持A型相的存在。


<details>
  <summary>Details</summary>
Motivation: 在非Kramers化合物中，多极状态在不同磁场方向下的能级分裂特性及其相行为，特别是在温度曲线中的异常行为，是当前研究的一个重要课题。

Method: 使用了沿[001]、[100]和[010]方向测量的磁性弹性特性，这些测量包括磁场下的磁性弹性张量和磁热学张量的具体数值。

Result: 通过比较实验结果与理论模型，发现O₂₀的四极矩具有很强的各向异性耦合，这为理解四极相互作用的形成提供了新的视角。

Conclusion: 通过对 PrIr₂Zn₂₀ 的无磁场热膨胀行为和不同磁场方向下的相行为进行分析，发现存在磁性驱动的A型相。
...
### [16] [Helical Quasiperiodic Chains with Engineered Dissipation: Liouvillian Rapidity Diagnostics of Transport and Localization](https://arxiv.org/abs/2511.21332)
*Mohammad Pouranvari*

Main category: cond-mat.str-el

TL;DR: 研究了具有准周期位势和N-近邻跳跃的一维二次无自旋费米链的Relaxation谱特性，通过引入局部分析和Majorana协变形式，精确处理了耗散和泵浦，分别为所有、单点和双点分立模式以及成对增益/损失，计算了雷诺比 rapidities和最小非零实部分，揭示了系统的Relaxation动力学特性与局域化效应。


<details>
  <summary>Details</summary>
Motivation: 准周期系统因其介于周期和无序之间的独特的物性，近年来受到广泛关注。通过局域的耗散和 pump 来研究这类系统的Relaxation动力学和局域化效应，具有重要的理论意义和实验应用价值。

Method: 本研究通过 Majorana 协变形式和第三量子化方法，精确计算了具有局域耗散和 pump 的一维无自旋费米链的雷诺比谱特性，分别考虑了均匀、单点和双点分立模式以及成对增益/损失。

Result: 结果表明，均匀耗散会导致较大的雷诺比间隙，而局域耗散会导致间隙迅速缩小，随着准周期位势的增强，系统因局域化而表现出增强的Relaxation能力。增大 N 值会改善模式重叠，从而增强耗散渠道。有限尺寸标度、雷诺比能级统计（Poisson vs Wigner-Dyson）及慢模式的空间分布，一致揭示了雷诺比谱结构如何关联系统transport和局域化特性。

Conclusion: 本研究将雷诺比谱作为实验上可探测的可靠判据，用于评估耗散和泵浦对开放量子晶格的Relaxation动力学和敏感度，在工程化设计中具有重要意义。
...
### [17] [Antiferromagnetism and Kekulé valence bond order in the honeycomb optical Su-Schrieffer-Heeger-Hubbard model](https://arxiv.org/abs/2511.21440)
*Sohan Malkaruge Costa,Benjamin Cohen-Stead,Steven Johnston*

Main category: cond-mat.str-el

TL;DR: 该论文研究了石墨烯相关材料中的e-ph相互作用及其与法律规定行为的关系。通过DQMC模拟，发现 Hubbarb 模型在石墨烯的合理参数范围内，表现出介于半金属(SM)和 Kekulé Valence Bond Solid (KVBS) 之间，同时显示出 AFM 阶和 KVBS/AFM 共存区域的迹象。e-ph 强度和 Hubbard repulsion 都能促使材料向 KVBS 阶转移，而非 AFM。


<details>
  <summary>Details</summary>
Motivation: 石墨烯的电子和声学性质在材料科学中具有重要意义，探索其特性和相关因素的研究具有潜在的应用前景。

Method: 通过无符号线状体相图模型框架，采用无符号体相图量子MonteCarlo模拟，研究了石墨烯中的e-ph相互作用。使用了有限尺寸比例分析，确定了模型的相图，并通过估计有效参数将其应用于实际石墨烯。

Result: 发现当 Hubbard repulsion 和 e-ph 强度适当调谐时，石墨烯可以向 KVBS 相位过渡，而非 AFM 相位。表明 e-ph 强度和 Hubbard repulsion 协同作用可以更有效地控制石墨烯的特性。

Conclusion: 通过修改 Hubbard repulsion 和 e-ph 强度，石墨烯可以实现从半金属到 Kekulé Valence Bond Solid 的可控转换，这对开发新材料和量子效应研究具有潜在的实用价值。
...
### [18] [Charge carrier relaxation dynamics in the one-dimensional Kondo lattice model](https://arxiv.org/abs/2511.21539)
*Arturo Perez-Romero,Mica Schwarm,Fabian Heidrich-Meisner*

Main category: cond-mat.str-el

TL;DR: 研究磁性激发对超快动力学的 Relaxation 过程，发现电子填充量和磁性背景对热化的影响。


<details>
  <summary>Details</summary>
Motivation: 研究超快动力学 Relaxation 动态，特别是在磁性激发中的作用，是理解热化机制的重要问题。

Method: 利用 1D Kondo 模型，结合时间依赖的 Lanczos 方法进行实时动力学模拟。

Result: 在磁性背景处于单重态时，即使单个电子孤立，也会发生热化；当磁性背景是铁磁态时，仅有少量电子被磁化才会发生热化。

Conclusion: 通过实验和理论分析，我们确认热化过程取决于磁性背景和电子填充量。
...
### [19] [Saturation Field as a Direct Probe of Exchange and Single-Ion Anisotropies in Spin-1 Magnets](https://arxiv.org/abs/2511.21551)
*M. A. R. Griffith,S. Rufo,H. Caldas,F. Dinola Neto,Minos A. Neto,J. R. Viana*

Main category: cond-mat.str-el

TL;DR: 该论文提出了一种基于SU(3)键算符框架的分析方法，系统地研究了高磁场条件下层状磁体的自旋动力学，得出了磁子波谱和相变临界磁场的解析表达式。研究结果表明，上临界磁场hc₂携带了相互作用和单离子对称性破坏的简单而定量的特征指纹，从而让高磁场实验成为研究微观自旋构型的理想工具。此外，该研究还揭示了层状材料中自旋单耗用度、相互作用和层间耦合如何控制磁子玻色爱因斯坦凝聚相溶胶的规模和位置。该研究为实态层状磁体材料中对称破坏机制的识别提供了实验可访问的标准。


<details>
  <summary>Details</summary>
Motivation: 研究高磁场环境下层状磁体材料的磁性自旋动力学，可能是为了更深入地理解材料中的微观结构特性及其在不同磁场下的行为变化，从而为材料科学和 condensed matter physics的应用开发提供理论依据。

Method: 该研究采用SU(3)键算符框架，通过理论分析和数学推导，得出了磁子波谱和界线场的解析表达式。数据处理主要基于解析数学推导而非实验证实。

Result: 研究结果表明，上临界磁场hc₂不仅能够反映相互作用强度和单离子对称性破坏程度，还能通过其特征指纹精确掌控层状材料中的微观自旋结构。此外，在磁场强度较高时，磁子玻色爱因斯坦凝聚相溶胶的形成范围和空间位置与材料中的自旋单耗用度、相互作用和层间耦合有直接联系。

Conclusion: 该研究通过理论建模，为层状磁体材料中的自我旋结构特性提供了一种新的研究视角。通过高温实验和磁场实验，可以更直观地测量这些理论预测的物理量。该研究结果不仅为理解这些材料中的自旋动力学术性和相变现象提供了重要工具，同时也为开发具有特殊自旋属性的材料打开了新的研究途径。
...
### [20] [Unconventional orders in the maple-leaf ferro-antiferromagnetic Heisenberg model](https://arxiv.org/abs/2511.21598)
*Lasse Gresista,Dominik Kiese,Simon Trebst,Yasir Iqbal*

Main category: cond-mat.str-el

TL;DR: 该论文通过多方法研究了菱叶结构Heisenberg模型的相图，揭示了多种新的量子有序相，包括六边形空穴态、六边形空穴体态、磁列体态等。


<details>
  <summary>Details</summary>
Motivation: 寻找复杂量子磁相的背景驱动力，

Method: 结合了集群平均场和伪费米功能重正化群方法，以及无约束的Luttinger-Kis泰勒方法。

Result: 发现了一系列新的量子有序相，扩展了无常规磁性相的区域，提供了关于量子磁性和相变的新见解。

Conclusion: 该研究扩大了我们对复杂量子磁相的理解，并提出了可用于探索新量子物态的理论框架。
...
### [21] [Mean-field Modelling of Moiré Materials: A User's Guide with Selected Applications to Twisted Bilayer Graphene](https://arxiv.org/abs/2511.21683)
*Yves H. Kwan,Ziwei Wang,Glenn Wagner,Nick Bultinck,Steven H. Simon,Siddharth A. Parameswaran*

Main category: cond-mat.str-el

TL;DR: 这篇综述详细介绍了魔层结构模型在莫伊尔材料中的应用，重点围绕魔层图灵层状图/graphene (MA-TBG) 的理论建模，特别是通过哈特里-福克平均场理论的研究方法。作者系统地讨论了从连续模型到相互作用的引入、平均场模拟的实现、强耦合极限、中间耦合的IKS秩序、时间依赖性及其实验应用等关键内容。综上所述，该论文通过丰富的理论分析和案例研究，展示了莫伊尔材料的复杂性和潜力。


<details>
  <summary>Details</summary>
Motivation: 魔层结构在材料科学中具有重要意义，尤其是在二维材料和强相互作用下的研究中，这篇论文通过系统的方法探讨了MA-TBG的理论模型，为后续研究提供了重要的理论框架.

Method: 该论文采用了理论建模与实验分析相结合的方法。首先通过连续模型描述魔层结构，然后引入相互作用并应用哈特里-福克平均场理论进行数值模拟，最后通过案例研究验证理论预测。

Result: 论文展示了魔层结构模型在MA-TBG中的应用，特别是在强耦合极限下的Exact ground states、中间耦合下的IKS秩序、时间依赖性下的集体模式以及通过hBNsubstrate stabilization的 Domain walls 能级研究等方面取得了显著成果。这些结果不仅丰富了理论知识，也为实验提供了指导。

Conclusion: 这篇综述为莫伊尔材料的研究提供了一个全面的理论框架，涵盖了从基本模型到复杂现象的各个方面。它不仅适合理论研究者参考，还能为实验ists提供深入的分析。
...
### [22] [Causal Rigidity and the Single-Unit Universe: Integrating the Alexandrov-Zeeman and Unruh Clock Scales](https://arxiv.org/abs/2511.20728)
*Karl Svozil*

Main category: gr-qc

TL;DR: 该论文讨论了时空的相对论性质和基本常数的数量，通过统一两种观点，证明了只存在一个基本常数。


<details>
  <summary>Details</summary>
Motivation: 研究时空的相对论性质和基本常数的数量是一个有趣且重要的课题。

Method: 论文的方法涉及结合物理和数学两个层面来分析问题。

Result: 结论是，只存在一个基本的常数。

Conclusion: 这一研究有助于我们更好地理解时空的基本结构和物理定律的内在联系。
...
### [23] [Denoising gravitational wave with deep learning in the time-frequency domain](https://arxiv.org/abs/2511.20731)
*Yi-De Lee,Hwei-Jang Yo*

Main category: gr-qc

TL;DR: 利用深度学习进行引力波去噪的研究显示 promise.


<details>
  <summary>Details</summary>
Motivation: 随着引力波探测的深入，理解和分析引力波信号变得愈发重要。

Method: 提出了基于深度学习的模型，结合Griffin-Lim算法和预先降噪的幅度谱。

Result: 实验结果显示，在模拟波形和真检测事件中，方法表现良好。”,

Conclusion: 该研究为引力波数据分析提供了新的方法学思路。
...
### [24] [Quantum coherent dynamics of quasiclassical spacetimes](https://arxiv.org/abs/2511.20759)
...
### [25] [Wormholes as perturbations of near-horizon black hole geometries: no-go theorems within effective field theories](https://arxiv.org/abs/2511.21017)
...
### [26] [Observational appearance and photon rings of non-singular black holes from anisotropic fluids](https://arxiv.org/abs/2511.21183)
...
### [27] [Black holes immersed in modified Chaplygin-like dark fluid and cloud of strings: shadows, quasinomal modes and greybody factors](https://arxiv.org/abs/2511.21205)
*Hao-Peng Yan,Zeng-Yi Zhang,Xiao-Jun Yue,Xiang-Qian Li*

Main category: gr-qc

TL;DR: 该研究探讨了静态球状黑洞在修正的 Chaplygin 类 dark 液体和弦云复合环境中的一致性研究，分析了黑洞影子、散射模式和灰体因数等方面。


<details>
  <summary>Details</summary>
Motivation: 对黑洞在不同物理环境中行为的研究有助于理解强引力效应及其在宇宙中的可能应用场景。

Method: 研究使用了 WKB 近似法来计算 Quasinormal 频率和灰体谱，并通过双因子环境下的视界极限来探讨黑洞影子与 QNMs 的关联。

Result: 结果表明，弦云强度对黑洞影子、QNMs 和灰体因数等关键指标有主要影响，而 dark 液体参数则带来了更复杂的但可预测的修改。

Conclusion: 该研究为探索极端黑洞环境提供了具体预测，有助于通过观测手段识别和研究此类环境中的黑洞。
...
### [28] [Scattering of charged massive scalar waves by Kerr-Newman black holes](https://arxiv.org/abs/2511.21318)
...
### [29] [Gravitationally-Induced Photon Entanglement in an FLRW Cosmological Background](https://arxiv.org/abs/2511.21403)
*Chi Zhang*

Main category: gr-qc

TL;DR: 一篇关于利用引力对光的影响实现量子纠缠以检测量子引力的论文总结。


<details>
  <summary>Details</summary>
Motivation: 探索量子引力存在的证据是前沿物理研究的重要方向，利用光作为量子系统的实验可能是可行的切入点。

Method: 作者提出了一个利用宇宙过程中产生的光实现量子纠缠的new方法，将引力效应与光的特性相结合，利用 LOCC 原理检验引力中介物的非经典性。

Result: 虽然光之间的引力作用极其微弱，但研究者通过量化的计算揭示了光自身引力场中量子纠缠的独特特征，这为未来在宇宙观测中实现光的量子纠缠提供了理论支持。

Conclusion: 这一研究为验证量子引力的存在提供了新思路，未来实验证实可能为量子通信和引力研究开辟新途径。
...
### [30] [Comment on "Charged scalar field at future null infinity via nonlinear hyperboloidal evolution" [Phys. Rev. D {\bf 112}, 104053 (2025), arXiv:2506.15311]](https://arxiv.org/abs/2511.21406)
*Shahar Hod*
...
### [31] [Simpson-Visser-AdS Black Holes: Thermodynamics and Binary Merger](https://arxiv.org/abs/2511.21424)
...
### [32] [Energy extraction from electrovacuum black holes via production of pairs of oppositely charged particles](https://arxiv.org/abs/2511.21429)
*Filip Hejda*

Main category: gr-qc

TL;DR: 研究展示了在旋转电荷黑洞中利用碰撞 Penrose 过程 Extract 能量，无需极端条件或精确调制，只要逃逸粒子足够带电。


<details>
  <summary>Details</summary>
Motivation: 探索在旋转电荷黑洞中通过碰撞 Penrose 过程提取能量的可能性，不论是极端条件还是非极端条件。

Method: 研究了 charged，旋转黑洞的碰撞 Penrose 过程；结合了位错电荷的产生模型，决定了逃逸粒子的电荷度。

Result: 证明了在普通条件下通过该过程可实现能量提取，特别是当逃逸粒子带有一定的电荷。

Conclusion: 提出了一个不需要极端条件或精确调制的能量提取方法，为黑洞的研究提供了新的视角。
...
### [33] [The relativistic tidal tensor: general solutions for stationary axisymmetric spacetimes and the Hills mass of naked singularities](https://arxiv.org/abs/2511.21499)
...
### [34] [Analytic First-Order Entanglement Entropy of Schwarzschild Black Holes with Interacting Scalars](https://arxiv.org/abs/2511.21504)
*Florin Manea*

Main category: gr-qc

TL;DR: 研究者计算了 Schwarzschild 黑洞视界上标量场四次相互作用的第一阶修正熵。使用光谱方法、复制技巧和热核方法，他们得到了一个闭合表达式，该表达式直接取决于视界面积、标量质量、相互作用强度以及曲率耦合。修正项显示出一个特征对数增强的二次发散，这个发散被重正化后的重力耦合吸收。在重正化后，熵遵循贝克enstein-Hawking 形式，具有有限的实际意义。结果表明，轻质场和强相互作用增强修正效果，曲率抑制效应，而共形耦合的场在首阶贡献上没有贡献。总体而言，这项工作展示了量子场相互作用如何通过重正化引力常数修改黑洞熵。


<details>
  <summary>Details</summary>
Motivation: 研究黑洞熵的量子场相互作用影响具有重要意义，可以在理论物理学中深入理解量子引力。

Method: 研究者使用光谱方法、复制技巧和热核方法计算了标量场的修正熵，还进行了参数分析。

Result: 修正项显示出对数增强的二次发散，这被重正化后的重力耦合吸收。重正化后，熵遵循贝克enstein-Hawking公式，具有有限的实际意义。参数分析表明，轻质场和强相互作用增强修正效果，曲率抑制效应，而共形耦合的场在首阶贡献上没有贡献。

Conclusion: 这项研究通过重正化引力常数展示了量子场相互作用如何修改黑洞熵，结果对理解量子引力和黑洞物理具有重要意义。
...
### [35] [Hidden symmetries and separability structures of Ovcharenko-Podolský and conformal-to-Carter spacetimes](https://arxiv.org/abs/2511.21538)
*Finnian Gray,David Kubiznak,Hryhorii Ovcharenko,Jiri Podolsky*

Main category: gr-qc

TL;DR: 研究发现了一类新的、非对齐的磁流体背景下的黑洞时空，这类时空比著名的Plebański–Demiański类更复杂，但仍属于D型时空。这类时空具有一个非退化的共形凯勒–杨诺2形式， encode了隐藏的对称性。与Plebański–Demiański类相比，尽管非对齐的磁流体背景破坏了关于对称性的塔定理，但这种对称性仍然可以用于分离变量，并在哈密顿–雅可比、共形波和无质量的狄拉克方程中求解。此外，这种对称性还允许处理无质量的矢量和张量扰动。这些结果为应用提供了有用的数学工具。研究还揭示了这些新时空作为检验 Penrose 电荷的背景，这些电荷与隐式而非显式对称有关。


<details>
  <summary>Details</summary>
Motivation: 研究黑洞在不同电磁场背景下的时空对称性，特别是非对齐场下的相关隐藏对称性，对于求解场方程和研究相关的守恒量和积分是有意义的。

Method: 该研究使用了Kerr-Newman度量为基础，引入了非对齐的磁流体场，计算共形凯勒–杨诺2形式的存在性及其对称性的影响。通过分析场方程和相关守恒量，得出了结论。

Result: 研究发现了新类时空具有非退化的共形凯勒–杨诺2形式，破坏了关于对称性的塔定理，但仍然保持了部分对称性。这种隐藏的对称性允许分离变量和求解多个场方程。此外，这些结果为研究 Penrose 电荷和隐式对称提供了新的测试背景。

Conclusion: 该研究扩展了对具有非对齐电磁场的黑洞时空的了解。通过引入新的隐藏对称性，这些时空为求解场方程和研究隐式对称提供了数学工具。未来的工作可以进一步探索这些时空在实际 astrophysical应用中的潜在物理意义。
...
### [36] [Cosmological Implications of the Extended Uncertainty Principle: Energy Conditions, Stability, and Late Time Acceleration](https://arxiv.org/abs/2511.21546)
*Maryam Roushan,Narges Rashidi*

Main category: gr-qc

TL;DR: EUP-corrected Friedmann equations are derived using thermodynamic methods. These equations lead to an unusual equation of state, analyzed with the CPL parametrization. The study examines the fulfillment of energy conditions and the stability of the model, concluding that the EUP cosmology has a late-time de Sitter attractor. The model's effective speed of sound is calculated, and it's suggested that EUP corrections could provide a viable alternative to the cosmological constant for late-time acceleration.


<details>
  <summary>Details</summary>
Motivation: Understanding the cosmological implications of extensions to quantum gravity frameworks, like the Extended Uncertainty Principle, is crucial for exploring the early and late universe's evolution.

Method: Thermodynamic arguments are employed to derive modified Friedmann equations, and the results are analyzed using the Chevallier-Polarski-Linder parametrization. stability analysis and energy conditions are also investigated.

Result: EUP-induced corrections are shown to produce consistent late-time acceleration without requiring a cosmological constant.

Conclusion: EUP cosmology offers a promising model for late-time acceleration, potentially complementing or even outperforming the standard cosmological constant approach.
...
### [37] [Estimation of the MTOV precision for ET, CE, and NEMO from the post-merger of BNS coalescences](https://arxiv.org/abs/2511.21573)
*Gabriela Conde-Saavedra,Odylio Denys Aguiar,Henrique P. de Oliveira,Maximiliano Ujevic*

Main category: gr-qc

TL;DR: The paper investigates the precision of determining the maximum mass of a spinless neutron star (MTOV) from gravitational wave signals detected by next-generation observatories. Results show that the Chinese Electron Telescope (CE) achieves the best mass precision with approximately 8% solar masses for the maximum merger rate of 250 Gpc⁻³yr⁻¹. The authors conclude that future ground-based gravitational wave observatories need to improve their sensitivity at high frequencies to enhance MTOV estimation precision.


<details>
  <summary>Details</summary>
Motivation: Understanding the properties of neutron stars, particularly their maximum mass, is a fundamental goal in astrophysics. Gravitational wave detections from neutron star mergers provide a unique opportunity to study these extreme objects and their evolution.

Method: The study employs numerical relativity simulations to model the post-merger signals from binary neutron star coalescences. The analysis focuses on the signal-to-noise ratio (SNR) in different frequency bands and calculates the achievable mass precision for various observatories, including the Chinese Electron Telescope (CE), the Cosmic Explorer (CE), and the Nancy Grace Roman Telescope (NEMO).

Result: The study reveals that CE achieves the best mass precision with approximately 8% solar masses for the maximum merger rate of 250 Gpc³yr⁻¹. Additionally, the research highlights the importance of sensitivity improvements at high frequencies for achieving better mass precision in MTOV estimation.

Conclusion: The authors conclude that future ground-based gravitational wave observatories must focus on improving their high-frequency sensitivity to achieve greater precision in estimating the maximum mass of a spinless neutron star. Their findings emphasize the need for continued advancements in detector technology to maximize the information gained from neutron star mergers.
...
### [38] [Tidal forces around the Letelier-Alencar cloud of strings black hole](https://arxiv.org/abs/2511.21604)
*Marcos V. de S. Silva,T. M. Crispim,R. R. Landim,Gonzalo Olmo,Diego Sáez-Chillón Gómez*

Main category: gr-qc

TL;DR: 研究了带有弦云的黑洞周围相对论性潮汐力，使用广义的Letelier-Alencar解。研究了静态对数引力和广义解的Kretschmann标量，发现广义模型在$r	o 0$时的曲率发散比Letelier和Schwarzschild情况更强烈。分析了测地运动：对于光速粒子，关注环形 photon轨道；对于高速粒子，考虑径向下逃和环形运动。发现光环半径和内最稳定轨道半径随弦云参数$g_s$增大而增大，随长度尺度$l_s$减小而减小；环形轨道在参数空间某些区域不存在。对于径向运动，计算了径向加速度和 tidal力，发现拉伸和压缩可能反转，通常在事件视界内。研究了圆轨道上观测者感受到的 tidal力，发现弦云即使在遥远区域也修改了开普勒频率和 tidal力曲线， tidal 的分量没有变号。


<details>
  <summary>Details</summary>
Motivation: 研究引力场中潮汐力的行为和影响，特别是带有奇怪物质分布的情况，如弦云，对理解广义相对论和黑洞物理有重要意义。

Method: 采用广义相对论的数学方法，分析静态解的性质，计算测地线和 tidal力。

Result: 发现在广义解中，潮汐力的行为发生改变，尤其是 tidal力的伸缩和压缩可能反转，且即使在远离黑洞时观测者也会感受到显著的 tidal效应 modification。

Conclusion: 弦云的存在显著影响了黑洞周围区域的潮汐力，拓展了我们对包含奇怪物质分布的引力系统理解。
...
### [39] [Nucleation and wetting transitions in three-component Bose-Einstein condensates in Gross-Pitaevskii theory: exact results](https://arxiv.org/abs/2511.21220)
...
### [40] [Dynamics of interacting bosons in a two-leg ring ladder with artificial magnetic flux and ac-driven modulations](https://arxiv.org/abs/2511.21445)
*L. Q. Lai*
...
### [41] [Analytical Approximations for Beamstrahlung at Very High Energy Electron-Positron Colliders](https://arxiv.org/abs/2511.20912)
*Dongxing He,Arianna Formenti,Spencer Gessner,Michael Peskin*

Main category: physics.acc-ph

TL;DR:  beamstrahlung simplifies in large quantum parameter limits and its spectra can be described by universal functions. 


<details>
  <summary>Details</summary>
Motivation:  understanding beamstrahlung in high-energy collisions is crucial for studying beam-beam interactions. 

Method:  Analyzed beamstrahlung spectra in the limit of large quantum parameter Υ. Derived universal functions to describe the spectra. Approximations were supplied for practical use. 

Result:  Beamstrahlung spectra for electrons and photons are described by universal functions in the large Υ limit. Approximations enable general studies of high-energy beam interactions. 

Conclusion:  Simplifying beamstrahlung description and providing useful approximations enhance studies of beam-beam interactions at high energies. 
...
### [42] [Generalizing the Shell Theorem to Constant Curvature Spaces in All Dimensions and Topologies](https://arxiv.org/abs/2511.20852)
...
### [43] [Super-resolution microscopy via fluctuation-enhanced spatial mode demultiplexing](https://arxiv.org/abs/2511.20790)
...
### [44] [Nonreciprocal Negative Refraction Enabled by Photonic Time Crystals](https://arxiv.org/abs/2511.20855)
*Mohammad R. Tavakol,Wenshan Cai*

Main category: physics.optics

TL;DR: We propose and theoretically demonstrate nonreciprocal negative refraction enabled by time-varying photonic structures by engineering temporal modulations at the interfaces of hyperbolic media. We achieve isolation between forward and backward beams while preserving negative refraction.


<details>
  <summary>Details</summary>
Motivation: The motivation behind this paper is to explore the possibility of designing photonic structures that can exhibit nonreciprocal properties, which are important for applications in wave manipulation and optical devices.

Method: The method involves engineering time-varying photonic structures, specifically hyperbolic media with temporal modulations at their interfaces. We developed two complementary approaches: one for the optical regime using multilayer AZO/ZnO hyperbolic slabs sandwiched between permittivity-modulated dielectric layers, and another for the microwave regime using a wire medium sandwiched between time-modulated resistive metasurfaces. Both designs exploit Floquet harmonic expansions.

Result: The results show that isolation exceeding 46 dB was achieved in the optical device and ~11 dB in the microwave counterpart. This demonstrates the effectiveness of our approach in achieving nonreciprocal negative refraction across different frequency regimes.

Conclusion: This work introduces a general framework for nonreciprocal negative refraction across frequency regimes, expanding the design space of time-varying metasurfaces and photonic time crystals.
...
### [45] [Accelerated Coupled Mode Model for Fiber Laser Amplifiers as an Averaged Dynamical System](https://arxiv.org/abs/2511.20981)
*Rebecca Bryant,Jacob Grosek,Jay Gopalakrishnan*

Main category: physics.optics

TL;DR: This paper presents an accelerated model for fiber laser amplifiers by applying mathematical techniques to simplify dynamical systems while maintaining high accuracy. The model achieves a fourfold increase in computational speed compared to the original method while preserving key performance metrics.


<details>
  <summary>Details</summary>
Motivation: The authors likely aimed to address the computational inefficiency of modeling fiber laser amplifiers, particularly to enable faster simulations for design and optimization purposes.

Method: The paper uses techniques from averaging theory of dynamical systems to modify the coupled mode theory (CMT) approach, resulting in an accelerated model. The authors supplement physical intuition with rigorous mathematical justification.

Result: The resulting model provides a fourfold computational speedup while maintaining high accuracy in key performance indicators. Additionally, the model’s framework is shown to be applicable to a broader range of amplifier configurations than previous models.

Conclusion: The paper succeeds in developing a more efficient yet accurate model for fiber laser amplifier simulations, making it a valuable tool for researchers and engineers in the field.
...
### [46] [A universal framework for nonlinear frequency combs under electro-optic modulation](https://arxiv.org/abs/2511.21059)
*Yanyun Xue,Xianpeng Lv,Guangxing Wu,Tianqi Lei,Chenyang Cao,Yiming Lei,Min Wang,Yan Li,Qihuang Gong,Di Zhu,Yaowen Hu*

Main category: physics.optics

TL;DR: 该摘要介绍了强耦合电光调制在非线性电光_comb中的重要性，提出了统一的理论框架和实验方法来解释其复杂动态，且提供了适用于各种调制模式的统一方程。


<details>
  <summary>Details</summary>
Motivation: 该研究旨在探索和解释强耦合电光调制在非线性电光_comb中的复杂动态，其目的是开发基于微波程序控制的光谱合成设备，这在精度测量、光谱分析及新兴的光子技术中具有重要意义。

Method: 该研究采用了一种通用的理论与实验结合的方法，通过引入通用演化方程（GEE）来扩展Lugiato-Lefever方程的应用范围，同时通过实验验证了该方法的有效性。

Result: 研究结果表明，强耦合电光调制与Kerr非线性之间存在协同动态，通过结合材料的非线性特性，可以进一步扩展微波频率合成的范围和复杂性。

Conclusion: 该研究为微米级的微波频率合成设备开发提供了理论基础和实验手段，有可能在精细测量、光谱分析和新兴光子技术中实现更高效、更精确的光频率合成，有望推动相关技术的发展和应用。
...
### [47] [Wavefront Reconstruction for Fractional Lateral Shear Measurements using Weighted Integer Shear Averages](https://arxiv.org/abs/2511.21072)
*Samia Heshmat,Satoshi Tomioka,Naoki Miyamoto,Yuji Yamauchi,Yutaka Matsumoto,Naoki Higashi*

Main category: physics.optics

TL;DR: This paper addresses the challenge of fractional shear in lateral shearing interferometry by proposing a weighted integer shear averaging method to improve wavefront reconstruction accuracy.


<details>
  <summary>Details</summary>
Motivation: Lateral shearing interferometry is widely used in wavefront reconstruction, but the assumption of integer shear amounts often limits its effectiveness. The proposed method aims to overcome this limitation by handling fractional shear more accurately.

Method: The method involves applying the weighted integer shear averaging technique, which combines reconstructions from nearby integer shears with weights designed to mitigate dominant error terms. Two-shear averaging removes first-order errors, and three-shear averaging removes second-order errors.

Result: Numerical simulations show that the method significantly reduces RMS error compared to conventional single-shear reconstruction, demonstrating its effectiveness and efficiency in handling fractional shear.

Conclusion: The proposed method is a simple, computationally efficient solution for wavefront reconstruction in scenarios where integer shear assumptions are not feasible, making it a practical and accurate tool for such applications.
...
### [48] [Passage of neutrons through accelerating crystal and the acceleration effect](https://arxiv.org/abs/2511.21125)
*A. I. Frank,V. A. Bushuev,M. A. Zakharov,G. V. Kulin*

Main category: physics.optics

TL;DR: 本文探讨了在接近布拉格条件时，中子穿过加速晶体时能量变化的问题，发现与长波中子穿过折射性样品类似，晶体的加速运动会导致中子能量变化，现象的物理本质归因于波在样品中入射和退出时的多普勒频移差异。与普通长波中子折射现象相比，在衍射占主导作用的波传播情况下，两者仅在定量方面有区别，实验数据与结果一致。


<details>
  <summary>Details</summary>
Motivation: 中子能量变化在加速过程中理解可能对核技术有重要应用

Method: 理论分析与实验验证

Result: 中子能量变化现象通过多普勒效应解释，与实验数据一致

Conclusion: otron效应下中子能量变化可用多普勒效应解释
...
### [49] [Low-dose Chemically Specific Bioimaging via Deep-UV Lensless Holographic Microscopy on a Standard Camera](https://arxiv.org/abs/2511.21311)
...
TL;DR: 报告了一种低光子数的DUV无镜头干涉光栅显微镜系统，使用标准的CMOS传感器，无需传统显微镜光学和特异光探测器，实现了大视场（116 mm²）的高分辨率化学特定对比。


<details>
  <summary>Details</summary>
Motivation: 随着生物医学研究的深入，高效的高分辨率显微成像技术变得尤为重要。DUV显微镜因其无标签、高分辨率的优势，受到广泛关注。然而，现有DUV显微镜面临显微镜结构复杂、成本高昂等问题，影响了其在生物医学领域的广泛应用。因此，开发一种高效、低复杂度的DUV显微镜系统显得尤为重要。

Method: 本研究采用了基于无焦点干涉成像技术，利用标准的CMOS传感器（通常用于可见光成像）来采集DUV光谱图像。通过结合深度散焦和多散焦像素超级分辨率重建技术（结合Total-Variation正则化和鲁棒自聚焦），显著提高了显微镜的性能。具体而言，该方法将有效像素尺寸减半，实现了约870 nm的间距分辨率。

Result: 该系统通过低光子数成像和化学特定对比实现了高分辨率显微镜。实验表明，在 challenging样本（如酵母菌、胞外osome和未上色的肝脏组织样）中，可实现无标签的生物成像。特别是在肝脏切片中，DUV光谱显微镜能够清晰显示脂类和抗原的聚集区域，并与Ole festival染色结果一致，从而无标签识别肝星细胞。

Conclusion: 本研究开发了一种低光子数、无传统显微镜光学和特异光探测器的DUV无焦点干涉显微镜系统，通过标准CMOS传感器和创新的超级分辨率重建算法实现了高分辨率的无标签生物成像。这为生物医学研究提供了高效、经济学友型、高分辨率的显微成像解决方案。
...
### [50] [All-Optical Varifocal Switching in a Polarization-Insensitive Si--GST Metalens](https://arxiv.org/abs/2511.21138)
*Dipika Rani Nath,Sadid Muneer,Sajid Muhaimin Choudhury*

Main category: physics.optics

TL;DR: 动态重建的金属分层在下一代平面光学平台上发挥着重要作用，但其实际性能受限于响应缓慢、光学损耗和极化敏感性。通过使用分层材料配合平面分层结构，可以实现动态光栅调制，例如利用Ge₂Sb₂Te₅这种相变材料。然而，可见光至短波红外范围的晶体Ge₂Sb₂Te₅的高度吸光性限制了其作动态分层镜的广泛应用。本研究设计了一种基于杂化Si-GST的全电介质非极化平面分层，实现了基于1.55μm波长的可调双焦分层镜。设备可以从70μm到200μm可变的焦距，并在无笑状效率分别为30%和20%。实验结果表明，通过平面激光均匀且可逆地在数十纳秒内完成相变。COMSOL Multiphysics模拟表明，基于相变材料的全电介质平面分层在实现 anyone层学控制和稳定性方面展现出巨大潜力。


<details>
  <summary>Details</summary>
Motivation: 随着平面分层技术的发展，其在现代光学领域中的应用越来越广泛，尤其是动态 rebuilding的应用场景。然而，实际应用受制于响应缓慢、高损失和对极化的敏感性限制，亟需创新性方法来克服这些限制。

Method: 研究中采用了分层材料结合平面分层架构的策略，我使用了杂化Si-GST的全电介质结构设计了可调双焦分层。实验中通过有限差分时域模拟(FDTD)验证了器件的性能，并利用COMSOL Multiphysics进行模拟来展示基于全平面激光的快速相变过程。

Result: 该方法实现了富文本_distances 增强的动态调制性能，设备在无相位变化状态下光聚焦效率为30%，而在相位变化状态下为20%，验证了方法的可行性。此外，相变过程在大约13ns至90ns可逆完成，无需机械运动或电偏置，展示了方法在控制和稳定性方面的优势。

Conclusion: 基于杂化Si-GST的全电介质非极化平面分层是实现下一代平面分层技术的理想选择，未来可以在此基础上开发适用于光束偏移、动态 holography、光导、多深度成像和光通信等多种应用。
...
### [51] [Design and Fabrication of Microfluidic Micro-Membranes by means of Two-Photon Polymerization](https://arxiv.org/abs/2511.21330)
*Vladimir Osipov,Alexander Dulebo,David J. Webb*

Main category: physics.optics

TL;DR: The study successfully demonstrated the use of a 520nm femtosecond laser for 2PP fabrication of micro-membranes with 1 μm channels using commercial materials, opening up possibilities for microfluidic devices.


<details>
  <summary>Details</summary>
Motivation: The authors aimed to showcase the feasibility of 2PP fabrication with high precision using available materials and a short wavelength laser, contributing to microfluidic device development.

Method: They employed a 520nm femtosecond laser to perform Two-Photon Polymerization (2PP) on commercial photopolymers (OrmoComp and FemtoBond) to create micro-membrane designs with channels as small as 1 μm.

Result: The fabrication was successful, achieving precise micro-membrane structures down to 1 μm, which is a significant advancement for microfluidic applications.

Conclusion: This method provides a cost-effective and versatile approach for manufacturing micro-membranes, enhancing the design capabilities of microfluidic devices.
...
### [52] [Simultaneous generation of Raman-assisted Soliton Microcombs and Tunable Multi-chromatic Raman Microlasers in Single Monolithic Thin-film Lithium Niobate Microrings](https://arxiv.org/abs/2511.21201)
...
TL;DR: A monolithic Z-cut LNOI microring platform for tunable multi-chromatic microlasers and Raman-assisted soliton microcombs with record-low pump threshold.


<details>
  <summary>Details</summary>
Motivation: High-bandwidth data processing, chip-scale metrology require advanced optical sources.

Method: Used Z-cut LNOI microring platform, Raman activity, high second-order nonlinearity, dispersion optimization, phase-matching configuration.

Result: Raman-quadratic nonlinear processes, on-chip efficient broadband coherent light source, Raman-assisted soliton comb at 1624.49 nm, pump threshold of 3.73 mW in telecom band, multi-chromatic lasers at ~1700, ~813, and ~535 nm, wavelength tuning of 5 nm.

Conclusion: This work represents a significant advance in integrated photonics for versatile optical signal generation.
...
### [53] [High resolution 3D imaging of diamonds with multiphoton microscopy](https://arxiv.org/abs/2511.21544)
*Elana G. Alevy,Samuel D. Crossley,Lam T. Nguyen,Vu D. Phai,Khanh Q. Kieu*

Main category: physics.optics

TL;DR: 该研究展示了使用多波长显微镜进行的非破坏性3D成像和光谱分析对钻石的表征方法及其应用


<details>
  <summary>Details</summary>
Motivation: 钻石作为光学技术发展的材料具有独特优势，该研究旨在开发非破坏性的快速分析技术，以满足钻石在地质研究、商业 worthless和光学技术应用中的需求

Method: 研究采用多波长显微镜（MPM）技术，通过非线性光效应实现了钻石的三次元成像和光谱分析

Result: 该方法成功揭示了钻石内部结构、荧光缺陷及形成条件，特别适用于评估宝石质量、研究量子技术中的空位中心以及追踪宝石的来源和处理历史

Conclusion: 多波长显微镜技术为钻石等材料的精准研究提供了高效工具，拓宽了在宝石鉴定、量子技术及地质研究等多个领域的应用前景
...
### [54] [Flexible mm-Wave Frequency and High-Speed Arbitrary IQ Signal Synthesis by a Photonic System on Chip](https://arxiv.org/abs/2511.21212)
*Bowen Zhu,Tao Zhu,Yazhi Pi,Chunyang Ma,Xiaochuan Xu,Zizheng Cao,Lei Wang,Shaohua Yu*

Main category: physics.optics

TL;DR: This paper demonstrates a flexible method for generating millimeter-wave and terahertz signals using photonic chips and optical frequency combs, enabling high bandwidth and arbitrary IQ signal construction.


<details>
  <summary>Details</summary>
Motivation: The paper aims to showcase a novel method for signal generation leveraging optical components to surpass traditional electronics in bandwidth, power efficiency, and minimal loss.

Method: A silicon photonic chip is combined with a reconfigurable optical frequency comb to perform on-chip filtering and modulation, generating high-bandwidth single and multi-frequency signals.

Result: The system successfully produces the necessary high bandwidth signals suitable for IQ construction in radio-over-fiber systems.

Conclusion: The approach offers significant advantages for applications such as radio-over-fiber, expanding potential in future communication systems.
...
### [55] [Mapping Nonlinear Mode Interactions in Coupled Kerr Resonators](https://arxiv.org/abs/2511.21233)
...
### [56] [Monitoring and Regulation of Micro-Displacement Deviation in Few-Mode Beam Alignment through Mode Decomposition](https://arxiv.org/abs/2511.21249)
...
### [57] [White light interferometry analysis for measuring thin film thickness down to few nanometers](https://arxiv.org/abs/2511.21383)
*Victor Ziapkoff,François Boulogne,Anniina Salonen,Emmanuelle Rio*

Main category: physics.optics

TL;DR: A practical white-light interferometric method is introduced for measuring thin non-opaque layers, such as foam films, with high precision using an open-source Python library called optifik. This method can resolve layer thicknesses down to a few nanometers and addresses common challenges like spectral complexity and noise.


<details>
  <summary>Details</summary>
Motivation: The development of this method is driven by the need for precise and efficient measurement of thin layers, which is critical in various scientific and industrial applications requiring detailed surface analysis.

Method: The methodology involves white-light interferometry supported by the optifik library. It processes spectral data to compute layer thicknesses, handling different spectral scenarios including complex fringes, moderate peaks, and few identifiable features. Additionally, the technique incorporates error considerations such as spectral range, refractive index knowledge, and spectral quality.

Result: The study successfully demonstrates the method's effectiveness through practical examples, including a time-resolved analysis of TTAB foam film changes. It highlights the method's versatility for measuring various materials and dynamic processes.

Conclusion: This paper presents a robust framework for spectrum-to-thickness mapping with wide-ranging applications, offering a significant advancement in coherent thickness measurements from time-resolved or static data.
...
### [58] [Integrated emitters with CMOS-compatible tuning for large scale quantum SiN photonic circuits](https://arxiv.org/abs/2511.21529)
...
### [59] [Investigating the Timing Behavior of Compton Scattering in BGO for Time-of-Flight PET](https://arxiv.org/abs/2511.20864)
*Minseok Yi,Daehee Lee,Alberto Gola,Stefano Merzi,Michele Penna,Simon R. Cherry,Jae Sung Lee,Sun Il Kwon*

Main category: physics.ins-det

TL;DR: 该研究利用BGO材料实现Cherenkov/闪烁TOF-PET探测器，尽管单晶研究展示了优秀的时间分辨率，但模块化结构中的InterCS事件导致 timing不准确。实验中使用了双像素探测器与分段SiPM读取，事件分类为全能量吸收（FED）、InterCS和穿透类型，结果显示超过25%的FED事件包含IntraCS。对于InterCS事件，选择较早的 timestamp可提升 coincidence timing分辨率，但 prompt photon收 yield减少。该研究强调了在BGO TOF-PET系统中采用时间明智的像素化 timestamp策略的重要性以保持最佳 timing性能。


<details>
  <summary>Details</summary>
Motivation: 随着TOF-PET在医学成像Field中的广泛应用，提高探测器的 timing性能至关重要，特别是针对含有散射成分的材料如BGO而言，开发有效的 timestamping策略是关键。

Method: 实验利用了双像素探测器和分段SiPM读取，结合能量加权定位和GATE模拟来分类和验证事件。

Result: 研究发现：1. InterCS事件占总事件的比例显著增加；2. prompt photon收 yield降低；3. InterCS事件的 timestamping性能不如FED事件；4. 时间意识的pixelated timestamp策略是必须的以保持最佳 timing性能。

Conclusion: 该研究展示了通过有效的 timestamping策略可以有效提升BGO探测器在InterCS环境下的 timing性能。
...
### [60] [Tungsten Germanide Single-Photon Detectors with Saturated Internal Detection Efficiency at Wavelengths up to 29 μm](https://arxiv.org/abs/2511.20868)
...
### [61] [Evaluating the Effective Segregation Coefficient in High-Purity Germanium (HPGe) Crystals for Ge Detector Development in Rare-Event Searches](https://arxiv.org/abs/2511.20879)
*S. Chhetri,D. -M. Mei,S. Bhattarai,N. Budhathoki,A. Warren,K. -M. Dong,S. A. Panamaldeniya,A. Prem*

Main category: physics.ins-det

TL;DR: This paper presents a detailed investigation of impurity distribution in a detector-grade HPGe crystal. By analyzing 37 longitudinal segments, the study provides high-resolution maps of dopant profiles and determines segregation coefficients and initial melt concentrations for key dopants like B, Al, Ga, and P. These findings enhance understanding of impurity transport and segregation under realistic growth conditions, informing process optimization for large-scale HPGe detectors used in rare-event physics experiments.


<details>
  <summary>Details</summary>
Motivation: Rare-event physics experiments rely heavily on the performance and scalability of their detectors. The use of high-purity HPGe crystals is crucial for minimizing background noise and ensuring accurate measurements. Understanding impurity distribution and segregation during crystal growth is essential for optimizing the production process and improving the overall quality and reliability of these detectors, which are vital for detecting rare events in physics research.

Method: The study involved analyzing a single crystal grown using the Czochralski method. The crystal was sectioned into 37 longitudinal segments, allowing for detailed mapping of dopant profiles. Hall-effect measurements were used to determine impurity concentrations in each segment. The data was then analyzed to calculate segregation coefficients and initial melt concentrations for boron (B), aluminum (Al), gallium (Ga), and phosphorus (P). The results were compared to classical models such as the Burton-Prim-Slichter model.

Result: The study found that impurities in the HPGe crystal exhibit complex segregation patterns that deviate from classical predictions. Effective segregation coefficients ($K_{eff}$) and initial melt concentrations ($C_0$) were determined for the dominant dopants. These results provide quantitative insights into the transport and partitioning of impurities under realistic growing conditions. The findings offer a foundation for optimizing the growth process of HPGe crystals, improving impurity control, and increasing the reliability of large-scale detectors for next-generation rare-event searches.

Conclusion: This research advances the understanding of impurity distribution and segregation in HPGe crystals. By leveraging high-resolution mapping and advanced measurement techniques, the study provides practical insights for optimizing the production of detector-grade HPGe boules. The enhanced understanding of dopant transport processes and segregation kinetics supports the development of more efficient and reliable HPGe detectors, which are critical for advancing rare-event physics experiments.
...
### [62] [A Hands-On Workshop for Constructing a Low-Field MRI System in Three Days](https://arxiv.org/abs/2511.20979)
...
TL;DR: 该论文描述了一种通过开源硬件和软件构建0.27T MRI Scanner的工作室方法，参与人员来自学术界和医疗行业，使用了多种开源组件完成了磁系统、梯度 coil 等模块的组装，并通过模拟和 fabrication 技术进行了准备。实验结果表明，构建的系统能够达到所需的磁强度，且具有良好的性能和实用性。


<details>
  <summary>Details</summary>
Motivation: 随着医学影像技术的不断进步，MRI scanners的需求也在不断增加，开源工具的使用降低了硬件的安装和维护成本，同时促进了知识共享和协作学习，这推动了MRI技术的发展。

Method: 论文采用了以下方法和步骤：1. 开发和准备阶段：使用开源软件 MaRCoS 和 PyPulseq 进行设计，并通过 CNC 加工和3D打印等 fabrication 技术完成硬件组件。2. 实施阶段：在为期三天的工作室中，参与者分别负责不同的系统模块，如磁系统、梯度 coil 和 RF 芯片的组装。3. 测试和优化：在组装完成后，进行了初步的测试，并根据结果对系统进行了优化。

Result: 1. 成功构建了一个 0.27T MRI scanner，磁强度达到 0.269T。2. 平滑调节（passive shimming）有效减少了场不均匀性，从 3mT 降低到 2mT。3. 制造了一个 3cm 直径的 RF 孤线，并将其调谐到 11.4MHz。4. 梯度模块在 simulations 中表现出少于 5% 的非线性率，并通过 CNC 加工建立了铜板梯度。5. 构建的系统能够进行 2D spin echo 扫描，后续进一步优化用于 relaxometry phantom 的扫描。6. 经过 workshops 的调查，超过 87% 的参与人员表示对构建 scanner 非常满意。

Conclusion: 该工作展示了开源工具和技术如何促进MRI scanners 的开发和实施，其结果对教育、脉冲序列设计和预临床研究具有重要意义。參加者对于结果 EITHER 非常满意或高度满意，表明了该方法的有效性和可行性。构建的 scanner 为未来的文化交流和技术创新奠定了基础，可能引发进一步的优化和应用探索。
...
### [63] [Rectification of stress by fiber networks: Manifestation of non-linear screening through self-organized buckling](https://arxiv.org/abs/2511.20754)
*Kanaya Malakar,Albert Countryman,Bulbul Chakraborty*

Main category: physics.bio-ph

TL;DR: 研究了纤维网络的无序变形模式与长程力传递的关系，发现拉伸模态主导着网络的重排过程，并导致泊松比的重排。


<details>
  <summary>Details</summary>
Motivation: 理解生物组织中的力传递机制对于生命运动和形态生成至关重要。

Method: 通过数值模拟研究纤维网络的变形模式，引入了力偶模型并分析了其对泊松比的影响。

Result: 纤维网络的拉伸模态主导长程力传递， organize的模式使泊松比出现重排。

Conclusion: 纤维网络的长程力传递主要受局部力偶强度支配，通过力偶组织可以调控大范围的 mechanical响应。
...
### [64] [A software-based focus system for wide-field optical microscopy](https://arxiv.org/abs/2511.20890)
*Ilyas Djafer-Cherif,Bartlomiej Waclaw*

Main category: physics.bio-ph

TL;DR: 该论文提出了一种基于机械运动的自焦点校正方法，无需额外硬件，通过软件实现对焦漂移的补偿，适用于长时间时滞成像。


<details>
  <summary>Details</summary>
Motivation: 长时间的生物样本成像在显微镜操作中不可避免地会遇到焦点漂移的问题，导致图像模糊，这对实验结果分析具有重要意义。

Method: 本文提出了一种基于Z轴机械运动的自焦点校正方法，无需额外硬件。通过在光阑的侧面附加标记，利用软件算法校正因焦点漂移而引起的图像模糊。实现工具选用Beanshell语言，开发了相应的校正脚本。

Result: 实验表明，该软件算法在多倍镜配置下表现良好，校正效果与硬件自动聚焦系统相当，尤其是在复杂的样品观察中显示出了更好的鲁棒性。

Conclusion: 该软件-based自焦点校正方法为显微镜长时间时滞成像提供了一种简单高效且成本低廉的解决方案。
...
### [65] [Baby universe as logical qubits: information recovery in random encoding](https://arxiv.org/abs/2511.20747)
...
### [66] [Locality constraints in AdS$_2$ without parity](https://arxiv.org/abs/2511.20749)
*Manuel Loparco,Grégoire Mathys,João Penedones,Jiaxin Qiao,Xiang Zhao*

Main category: hep-th

TL;DR: 研究AdS2量子场论中的 bulk局域性约束。已知AdSd+1中的局域性求和规则对于d=1不适用，因AdS2边界共形块的不同奇点结构及操作符顺序的非等价性。假设单元性和低位增长条件，我们获得幂律界限，推导散射关系，并用“偶”和“奇”局域块的展开式，这些块在所有AdS2中收敛。这导致两个新的对称和反对称局域求和规则。我们用自由标量场论显式测试了这些求和规则。


<details>
  <summary>Details</summary>
Motivation: AdS/CFT对偶是理论物理和量子 gravity的重要研究领域。理解AdS2中的局域性约束对量子场论的局域性性质和AdS/CFT的边界条件下有着深远的意义。

Method: 我们通过研究AdS2中的共形块奇点结构，假设单元性和低位增长条件，推导出幂律界限并导出散射关系，然后用局域块的展开式来建立新的局域求和规则。

Result: 我们成功导出了两个新的对称和反对称局域求和规则，并用自由标量场论进行了验证。

Conclusion: 我们的研究为AdS2中的局域性约束提供了新的框架和求和规则，进一步丰富了AdS/CFT的理论基础，同时为未来研究量子 gravity和量子场论的边界条件提供了新工具。
...
### [67] [On the role of Area Metrics in AdS/CFT](https://arxiv.org/abs/2511.20753)
...
### [68] [Krylov Complexity of Supersymmetric SYK Models](https://arxiv.org/abs/2511.20769)
*James Chryssanthacopoulos,David Vegh*

Main category: hep-th

TL;DR: 该研究探讨了超对称性破坏对Krylov复杂性的影响，在具有$	extcal{N}=2$超对称性的$	extcal{N}=2$ SYK模型中，通过不相干变形和质量变形的Hamiltonian引入了超对称性破坏。研究发现，两种变形均会扩大Krylov空间，但质量变形的影响更显著。Krylov复杂性呈现二次增长后转为线性增长，两种变形都能提高早期复杂性增长速率。然而，不相干变形会增加复杂性的饱和值，而质量变形则会减少。这些结果揭示了超对称性破坏对量子复杂性的影响。


<details>
  <summary>Details</summary>
Motivation: 复杂性在量子物理学中的重要性日益凸显，尤其是在量子引力和弦论中。研究复杂性如何受超对称性破坏的影响，有助于深入理解超对称性与复杂性之间的关系，以及复杂性随时间的演化。

Method: 研究者使用Krylov子空间方法，分析了拉姆齐数列、Krylov维度、复杂性和熵在有限系统大小下的行为作为形变强度的函数。

Result: 两种形变均扩大了Krylov空间。Krylov复杂性显示二次增长后转为线性增长。两种形变都在早期提高了复杂性增长率。此外，与超对称性相比，质量形变会减少复杂性饱和值，而质量形变会增加复杂性饱和值。

Conclusion: 该研究表明，超对称性破坏能够显著影响Krylov复杂性。不相干形变对比质量形变产生不同的影响，这为理解超对称性与复杂性之间的关系提供了新的视角。研究结果不仅适用于$	extcal{N}=2$ SYK模型，还可能推广到其他类型模型和系统。
...
### [69] [Exact WKB in all sectors II: Potentials with non-degenerate saddles](https://arxiv.org/abs/2511.20778)
...
### [70] [Marginal Operators from Celestial Diamonds](https://arxiv.org/abs/2511.20807)
...
### [71] [Three-dimensional non-relativistic chiral massive higher-spin gravity](https://arxiv.org/abs/2511.20818)
*Arpita Mitra,Debangshu Mukherjee,Tung Tran*

Main category: hep-th

TL;DR: 研究通过Lifshitz形变和后续的null简并，将AdS4中的chiral无质量高自旋引力转化成AdS3中的非相对论性chiral杂质量高自旋引力。因为在原4d的chiral无质量高自旋引力中共有不够多的动态生成器，因此其对应的顶点比原来的4d的更为松散。通过简单的近似关系，使得在大自旋数下，高自旋相互作用被积压，符合低能物理的属性。猜测这种非相对论性chiral杂质量高自旋引力的 holographic对偶是一个二维的非相对论性Landau-Ginzburg理论，在轻锥坐标下。该理论应描述一个1维空间中的两种流体系统的λ点。


<details>
  <summary>Details</summary>
Motivation: 研究者运用Lifshitz形变和null简并技术，将4维的AdS中的无质量高自旋引力转化为3维的非相对论性chiral杂质量高自旋引力，并猜测其对应的holographic对偶是非相对论性二维Landau-Ginzburg理论并应用于描述1维空间中的流体系统。

Method: 研究方法主要是运用Lifshitz形变和null简并技术，对AdS4中的chiral无质量高自旋引力进行分析和变换，便于转化为AdS3空间的非相对论性chiral杂质量高自旋引力。同时，通过对理论中的顶点动态生成器数量提出假设，并且估计其相互作用被积压的特性，以此得出结论。

Result: 研究结果表明，在大自旋数下，高自旋相互作用被积压，符合低能物理的特性。研究者进一步猜测该非相对论性chiral杂质量高自旋引力的 holographic对偶为二维非相对论性Landau-Ginzburg理论，并用来描述1维空间中的两种流体系统。

Conclusion: 这一研究成功地将4维的AdS中的高自旋引力转化为3维的非相对论性chiral杂质量高自旋引力，并猜测其对应的holographic对偶是二维非相对论性Landau-Ginzburg理论。该结论为1维空间中两种流体系统的相变模型 Offers一个新的理论视角。
...
### [72] [Towards six W-boson amplitude at two loops](https://arxiv.org/abs/2511.20828)
*A. V. Belitsky*

Main category: hep-th

TL;DR: The paper constructs the planar integrand for the six-leg amplitude of massive W-bosons using advanced techniques, and its massless limit corresponds to the six-gluon MHV amplitude, extending patterns from lower leg numbers.


<details>
  <summary>Details</summary>
Motivation: The research contributes to understanding scattering amplitudes in gauge theories, particularly in maximally supersymmetric Yang-Mills, by computing high-loop integrands for multi-particle amplitudes.

Method: The authors use the six-dimensional supersymmetric spinor-helicity formalism and the generalized unitarity-cut sewing technique to analyze the integrand.

Result: The result is the two-loop integrand for the six-leg amplitude of massive W-bosons, which reduces to the known six-gluon MHV amplitude in the massless limit.

Conclusion: This work builds on previous findings for four- and five-leg amplitudes, showing a pattern where massive amplitudes are uplifts of massless ones to higher dimensions.
...
### [73] [Holographic entanglement entropy and c-functions in conformal and confining backgrounds](https://arxiv.org/abs/2511.20891)
*Jonathan Whittle*
...
### [74] [Palatini Gauss-Bonnet theory](https://arxiv.org/abs/2511.20903)
*Maximo Banados,Marc Henneaux*

Main category: hep-th

TL;DR: 该研究探讨了偶时空维度2n中与Chern-Simons理论相似的模型，其动力学变量为GL(2n)联络和内空间度量。当n=1时，在2维时空中，该理论可表示为约束BF模型，但其动力学在n>1时更复杂，更高维度中存在局域自由度。


<details>
  <summary>Details</summary>
Motivation: 该研究动机是借鉴Chern-Simons理论在奇维时空中的成功应用，探索在偶维时空中的相似结构和模型行为，以拓展对低维与高维时空理论的理解。

Method: 研究采用了构造性方法，引入GL(2n)联络和内空间度量作为基本变量，设计了一个多项式作用量，其次数根据n参数化。通过具体分析n=1和n=2的情况，揭示了理论在不同维度中的行为差异。

Result: 主要结果包括：2维时空（n=1）中理论阐述为约束BF模型，而更高维度（n>1）中存在局域自由度。研究成功展示了更高维时空中局域自由度的出现及其面临的挑战。

Conclusion: 该研究为偶数维时空中的规范理论提供了新视角，展示了GL(2n)联络与度量共同作用下不同维度中的理论行为差异，为更复杂模型的进一步研究奠定了基础。
...
### [75] [From closed to open strings: the tensionless route in Kalb-Ramond background and noncommutativity](https://arxiv.org/abs/2511.20917)
*Sarthak Duary,Sourav Maji*

Main category: hep-th

TL;DR: 研究了张力为零的 bosonic 弦在 Kalb-Ramond 背景中的行为，表明弦在 tensionless 的情况下从闭弦转变为开放 sting。实现了 worldsheet 的Bogoliubov 变换，使得闭弦的 vacuum 变成了开放弦的广义边缘真空。通过 Toroidal 紧致化，发现 worldsheet 的 Bose-Einstein 凝聚依然是适用的。通过 边界 symplectic 形式，得到了 open string 的非交换参数，显示出在 tensionless 情况下，$B$-场项是唯一的贡献，且与 Seiberg-Witten 结果相符。


<details>
  <summary>Details</summary>
Motivation: 弦理论中的相变和弦分支是一个重要的研究领域，尤其在 tensionless 的情况下，闭弦到开放弦的转变是一个有趣的物理现象。同时，非交换几何在当前理论物理中也是一个热门话题，理解这些概念的来源和机制对我们理解弦理论的基础和数学结构具有重要意义。

Method: 通过在 Kalb-Ramond 背景中研究张力为零的 bosonic 弦的行为，引入了 Carrollian 限制，揭示了 worldsheet 的Bogoliubov 变换，并通过构造混合边界条件和 gluing matrix，得出了广义的边缘真空状态。对于环面紧致化的情况下，这项研究继续适用，通过 worldsheet 的 Bose-Einstein 凝聚机制。对于 symplectic derivation 的方法，边界 symplectic 形式单独决定了非交换几何，且在张力为零的情况下，$B$-场项是唯一的贡献。

Result: 在张力为零的情况下，通过在 Kalb-Ramond 背景中研究 bosonic 弦，实现了闭弦到开放弦的转变，并通过构造 worldsheet 的 gluing matrix 和边界条件，得出了广义的边缘真空。这一过程通过边界 symplectic 形式，得到了 open string 的非交换参数，显示了张力为零的情况中 $B$-场项的唯一性贡献，并与 Seiberg-Witten 结果相吻合。环面紧致化情况下的机制仍适用 Bose-Einstein 凝聚。

Conclusion: 研究展示了，在张力为零的 bosonic 弦情况下，在 Kalb-Ramond 背景中，通过 worldsheet 的边界条件和 Bogoliubov 变换，实现了闭弦到开放弦的转变。通过构造 gluing matrix 和边界 symplectic 形式，得出了 open string 的非交换参数，并展示了这一机制在环面紧致化情况下的适用性。结果一致地与当前理论物理中的非交换几何和弦理论分支相吻合。这项工作为理解张力为零情况下的弦理论分支和非交换几何提供了重要的理论支持。
...
### [76] [Magnetic corrections to the classical soft photon theorems at all orders](https://arxiv.org/abs/2511.20918)
*Sarthak Duary,Pabitra Ray*

Main category: hep-th

TL;DR: 研究了带有电荷和磁荷的物体相碰后散开并辐射电磁波的过程，推广了经典软光子定理，计算了电场和磁场波形的低阶项，并验证了群论下电荷-磁荷对称性。提供了显式表达式，依赖于运动学数据和电荷-磁荷特性。


<details>
  <summary>Details</summary>
Motivation: 在这之前的工作中，仅考虑了经典软光子定理中主项，没有考虑低阶修正项。然而，信息论、弦理论和量子场论等领域都关心这些低阶修正。本研究旨在扩展分析，计算电场和磁场的低阶项，验证电荷-磁荷对称性和群的性质。

Method: 采用了电动力学和电-磁对称性理论，独立的电势和磁势来计算电场和磁场的完全软展开。通过递归关系式计算轨迹系数和波动函数，并验证了电荷-磁荷对称性下的协变性。

Result: 电场和磁场的波动函数在电荷-磁荷对称性下表现为二维旋转群SO(2)的双奇异，这意味着波动函数在对称性变换下变换为标量乘以生成元。方法不仅能够计算单体散射问题的全波展开，还能转换成时间域和频域的表达式。

Conclusion: 论文的成功之处在于扩展了经典软光子定理，计算了电场和磁场的完整的低阶展开，并验证了电荷-磁荷对称性在电动力学与群论中的重要性。这为后续的研究提供了有用的理论工具和计算框架。
...
### [77] [Weak gravity at micron scales from dark bubble cosmology and its cosmological consequences](https://arxiv.org/abs/2511.21362)
...
### [78] [Thermodynamics and $P$-$V$ Criticality of Charged AdS Black Holes with a Cloud of Strings in Kalb-Ramond Gravity](https://arxiv.org/abs/2511.21374)
*Faizuddin Ahmed,Edilberto O. Silva*

Main category: hep-th

TL;DR: 研究了AdS双迷彩引力中带有字符串云的带有电荷的反德萨斯黑洞的扩展相空间热力学和PV相图特性。通过引入维度参数ℓ和α，改变了对称性，Signifcantly影响了热力学性质。


<details>
  <summary>Details</summary>
Motivation: 研究AdS spacetime中带有双迷彩引力和字符串云的黑洞热力学性质，帮助理解高能物理和引力理论中的相变和相结构。

Method: 通过求解双迷彩引力和字符串云背景下的爱因斯坦场方程，计算了热力学量、温度、熵、压力、体积、内能和拐点，分析了ℓ和α对稳定性的影响。

Result: 导出了范德华型状态方程，计算了临界点(Pc, Tc, vc)，并发现它们与ℓ和α有非线性依赖，但存在的拓扑电荷比值Pc vc/Tc = 3/8被保留。使用热力学拓扑方法确定了总拓扑电荷W=1，与Reissner-Nordström-AdS黑洞相同。通过约尔当-汤米son膨胀，推导了逆转曲线，发现倒的情况温度极小值满足Ti min / Tc = 1/2，与Reissner-Nordström-AdS情况相同，说明ℓ和α变形了热力学尺度但没有改变基础的通用性类。

Conclusion: 研究了带有字符串云的带有电荷的反德萨斯黑洞在双迷彩引力中的扩展相空间热力学和PV相图特性。通过引入参数ℓ和α，显著影响了热力学性质，特别是范德华类方程的状态方程和Reissner-Nordström-AdS的同源性。导出了临界点和逆转曲线，表明在改变热力学尺度的同时保持了基础的通用性类。这些结果为理解高维引力和量子重力理论中的相变提供了一定的见解。
...
### [79] [Notes on Fourier transform and its application to three-point momentum-space integrals](https://arxiv.org/abs/2511.21493)
*Xuhang Jiang*

Main category: hep-th

TL;DR: 研究了两个外线腿和无质量传播器的两点动量空间费曼积分的傅里叶变换，并利用这些积分的半径状身份来建立实验数据。


<details>
  <summary>Details</summary>
Motivation: 为了简化无质量费曼积分的计算，找到了一种新的数学方法。

Method: 使用傅里叶变换和半径状身份来研究费曼积分的性质。

Result: 推广了一种更一般性的方法来处理具有三个外线腿的无质量费曼积分，并应用于非平面结构的积分。

Conclusion: 这种方法为计算这些复杂结构的费曼积分提供了一个有效的工具。
...
### [80] [Zoo of flows in a 3d gauged supergravity with periodic potential](https://arxiv.org/abs/2511.21558)
...
### [81] [Cosmological tensions in Proca-Nuevo theory](https://arxiv.org/abs/2511.21071)
*Hsu-Wen Chiang,Claudia de Rham,Sebastian Garcia-Saenz,Xue Zhou*

Main category: hep-th

TL;DR: 研究了扩展Proca-Nuevo理论的宇宙学预测，该理论矢量-张量理论提供了稳定的均匀和各向同性的解，适用于暗能量模型的检验。分析结果表明，该模型在背景模型和观测约束方面有了改进，缓解了哈勃张力，并通过矩阵率调整达到了与观测数据一致的匹配。


<details>
  <summary>Details</summary>
Motivation: 该研究旨在通过矢量-张量理论探索新的宇宙学模型，特别是Proca-Nuevo理论在暗能量和宇宙学矛盾方面的应用。

Method: 研究采用了一般的一阶参数类背景模型，并通过观测数据（如CMB、BAO和低红shift数据）进行分析计算。

Result: 研究发现，扩展Proca-Nuevo模型在拟合CMB和BAO数据时比ΛCDM模型更优，缓解了哈勃张力问题，但在调整矩阵率以匹配观测数据时需要一定的校准。该模型在矢量-张量理论范畴内具有广泛的应用前景。

Conclusion: 这项工作展示了扩展Proca-Nuevo理论在解决宇宙学矛盾中的潜力，并为后续研究提供了新的方向。
...
### [82] [Heterotic Black Holes in Duality-Invariant Formalism](https://arxiv.org/abs/2511.21687)
*Upamanyu Moitra*
...
### [83] [High-Resolution Laser Spectroscopy on the Hyperfine Structure of $^{255}$Fm (Z=100)](https://arxiv.org/abs/2511.20921)
...
### [84] [Directional loss of contrast by dephasing in temporal double-slit interferometry](https://arxiv.org/abs/2511.21094)
...
### [85] [Bridging Atomistic and Mesoscale Lithium Transport via Machine-Learned Force Fields and Markov State Models](https://arxiv.org/abs/2511.20863)
...
TL;DR: This paper introduces an innovative multiscale framework combining AIMD, MLFFs, and MSMs to model lithium diffusion in battery anodes, capturing rare diffusion events and providing mechanistic insights.


<details>
  <summary>Details</summary>
Motivation: The study addresses the challenge of modeling lithium diffusion in solid-state battery anodes, which is critical for improving energy storage technology. The rare nature of diffusion events on standard AIMD timescales calls for advanced modeling techniques to enable broader timescale simulations.

Method: The researchers employed a bottom-up approach integrating ab initio molecular dynamics (AIMD), machine-learned force fields (MLFFs), and Markov state models (MSMs). AIMD simulations were used to train MLFFs to match DFT accuracy while enabling efficient large-scale simulations. MSMs were then constructed from long MLFF trajectories to model lithium transport across various timescales.

Result: The combined framework successfully propagated lithium distributions across extended timescales, accurately predicting diffusion coefficients and capturing rare diffusion processes. The MSMs provided detailed mechanistic insights, including relaxation timescales and dominant transport pathways.

Conclusion: This framework offers a scalable and transferable method for studying lithium transport in both crystalline and amorphous solid-state anodes, enhancing our understanding of battery materials and potentially improving their performance.
...
### [86] [Different Rise Times of Atomic Br M$_{4,5}$ 3d$_{3/2,5/2}$ Core Level Absorptions during Br$_{2}$ C $^{1}Π_{u}$ $1_{u}$ State Dissociation via Extreme Ultraviolet Transient Absorption Spectroscopy](https://arxiv.org/abs/2511.21165)
*John E. Beetar,Jen-Hao Ou,Yuki Kobayashi,Stephen R. Leone*

Main category: physics.chem-ph

TL;DR: The paper investigates bond-breaking dynamics of Br₂ using attosecond XUV spectroscopy, revealing variation in dissociation times across methods and providing insights into transition dependence on bond length.


<details>
  <summary>Details</summary>
Motivation: Understanding reaction mechanisms at the atomic scale requires precise measurement of bond-breaking dynamics, which are crucial for fields like quantum chemistry and materials science.

Method: Attosecond extreme ultraviolet (XUV) transient absorption spectroscopy was used to study core-to-valence and core-to-Rydberg transitions at the Br M4,5 edges.

Result: Probe transition dynamics affect observed timescales: 3d to 4p transitions have rise times of ~38-20 fs, while 3d to Rydberg transitions show complex, multiple timescale features due to spectral overlaps.

Conclusion: Dissociation dynamics depend significantly on the choice of probe transition, offering a nuanced understanding that must be considered in future experiments and data interpretations.
...
### [87] [Design of a Plastic Inorganic Semiconductor GaPS4-Based Gas Sensor for Conformal Monitoring of Gas Lines](https://arxiv.org/abs/2511.21348)
*Qiao Wang*
...
### [88] [Diffusion-controlled reaction rate to an active site in a spherical cavity: Extension of Berg's theory](https://arxiv.org/abs/2511.21357)
...
### [89] [A Low Cost Relativistic Algebraic Diagrammatic Construction Method Based on Cholesky Decomposition and Frozen Natural Spinors for Electronic Ionization, Attachment and Excitation Energy Problem](https://arxiv.org/abs/2511.21640)
...
### [90] [Floquet thermalization by power-law induced permutation symmetry breaking](https://arxiv.org/abs/2511.21284)
...
### [91] [Centipedes Leap into the Quantum Realm](https://arxiv.org/abs/2511.20690)
*Kaytki Chakankar,Xinhui Tang,Yiguo Zhang*

Main category: quant-ph

TL;DR: This paper introduces a quantum strategy for the centipede game that outperforms classical strategies.


<details>
  <summary>Details</summary>
Motivation: The paper investigates whether quantum strategies can improve outcomes in the centipede game, a non-zero-sum game where players take or pass a growing reward.

Method: The authors used principles from quantum mechanics and the framework of the prisoners' dilemma to develop quantum strategies for the centipede game. They implemented their algorithm using Qiskit, a Python library for quantum computing.

Result: The quantum strategies outperformed classical strategies by achieving better payoffs for both players and more accurately modeling real-life outcomes.

Conclusion: The findings suggest that quantum strategies can be effective in solving certain types of games and provide a promising direction for future research.
...
### [92] [Relativistic Quantum-Speed Limit for Gaussian Systems and Prospective Experimental Verification](https://arxiv.org/abs/2511.20707)
*Salman Sajad Wani,Aatif Kaisar Khan,Saif Al-Kuwari,Mir Faizal*

Main category: quant-ph

TL;DR: 研究推导了相对论性 corrections到连续变量量子系统中的量子速度极限，展示了在高速或强引力场环境下量子时钟网络的理论与实现实验可行性。


<details>
  <summary>Details</summary>
Motivation: 量子通信、引力波探测和空间钟网络的技术瓶颈在于量子速度极限（QSL）。由于现有基准忽略了相对论效应，特别是在相干态和寿命扩张态中，这的研究具有重要意义。

Method: 研究方法涉及Mandelstam-Tamm与Margolus-Levitin界限的推导，利用折合动量展开法和波动-振荡子描述进行状态传播的闭式求解。研究引入了相对论动能项的共振态作为了扰动，并计算了相关的量子信息论指标。

Result: 相对论性修正慢化了态的演化，尤其是在振幅和挤压依赖的情况下，并提高了量子速度极限的上限。此外，研究发现了一种ε²t²的相位漂移，这种漂移削弱了时间分辨率，但增加了共鸣因子。实验表明，一个小振幅的电子在强磁场中的陷阱中，在一定时间内可以观察到这种相移。

Conclusion: 该研究为连续变量量子系统中的相对论性QSL提供了理论框架，并通过模拟实验证明了其适用性。这些发现为未来在高速或强引力场环境下的量子技术基准化提供了新的理解。
...
### [93] [Real-time Monitoring of Neon Film Growth for Electron-on-Neon Qubits](https://arxiv.org/abs/2511.20765)
*Sidharth Duthaluru,Kaiwen Zheng,Erik A. Henriksen,Kater W. Murch*

Main category: quant-ph

TL;DR: This paper demonstrates a method to monitor and control the growth of solid neon films for electron-on-neon qubits in superconducting circuits, utilizing high-temperature superconductor (HTS) YBCO microwave resonators. They found that by increasing the driving power in the resonator, they could reduce the final neon film thickness effectively.


<details>
  <summary>Details</summary>
Motivation: The project aims to address the challenge of forming and controlling the thickness of solid neon films on superconducting circuit surfaces for quantum computing applications, specifically using electromagnetically induced transparency (EIT) qubits. The importance lies in the potential to realize more robust and controllable qubits for advanced quantum processing systems.

Method: The researchers implemented a real-time monitoring system using high-transition-temperature (HTT) YBCO microwave resonators, leveraging their high critical current density, enabling a tracking range near the critical temperature and below. They performed over 300 solidification experiments, controlling parameters such as the driving power of the resonator to observe how the final neon film thickness varies. A key insight was that higher driving power consistently led to thinner final films, primarily in the range of tens of nanometers.

Result: The study reveals that the final thickness of neon films can vary stochastically from a few nanometers to several micrometers when formed from a liquid phase. However, by increasing the driving power in the resonator, the final thickness can be reduced to below 100 nanometers. This result is significant as it represents progress toward controlled formation of neon films for electron-on-neon qubits and highlights the broader applicability of HTS resonators in hybrid quantum systems.

Conclusion: This research represents an important step toward achieving the controlled synthesis of neon films forSuperconductor based qubits, potentially enabling more advanced and reliable quantum computing systems. It also underscores the utility of high-temperature superconductors in hybrid quantum systems beyond just qubit implementations. Next steps likely involve optimizing the thickness for specific applications require more studies and possibly higher quality HTS technology.
...
### [94] [Comment on Classical-Gravity--Quantum-Matter Claims About Gravity-Mediated Entanglement](https://arxiv.org/abs/2511.20717)
*Mikołaj Sienicki,Krzysztof Sienicki*

Main category: quant-ph

TL;DR: The paper discusses whether a classical gravitational field can generate entanglement between two masses. A critique argues that under realistic conditions, such entanglement is unlikely. The authors clarify key points, restate the critique, reformulate it, and explain the difference between entanglement in pre-existing quantum matter and entanglement mediated by a gravitational field. The conclusion maintains that observing gravity-mediated entanglement supports the idea of nonclassical gravity.


<details>
  <summary>Details</summary>
Motivation: Understanding whether a classical gravitational field can generate quantum phenomena, like entanglement, is fundamental to quantum gravity research. This has implications for our understanding of spacetime and quantum mechanics.

Method: The authors analyze a previous argument that quantum matter coupled to a classical gravitational field can generate entanglement. They address the critique by Marletto, Oppenheim, Vedral, and Wilson, reformulating it and clarifying assumptions.

Result: The critique is clarified and restated, reformulated, and the distinction between entanglement in pre-existing quantum matter and mediating entanglement via a gravitational field is highlighted.

Conclusion: The standard conclusion that gravity-mediated entanglement strongly indicates nonclassical gravitational degrees of freedom remains valid despite the critique.
...
### [95] [Quantum theory of electrically levitated nanoparticle-ion systems: Motional dynamics and sympathetic cooling](https://arxiv.org/abs/2511.21495)
*Saurabh Gupta,Dmitry S. Bykov,Tracy E. Northup,Carlos Gonzalez-Ballestero*

Main category: quant-ph

TL;DR: 论文开发了一个量子多耦合动力学理论，描述了微粒和离子在双频线性Paul traps中的中心质点运动。他们导出了运动频率和经典轨迹的解析表达式，并推导出了离子和微粒系统的量子细致平衡方程以量化微粒通过与其被持续Doppler冷却的离子的库仑耦合而获得 sympathetic冷却。他们预测即使在无运动反馈或存在微运的情況下，运动冷却到亚开尔温温度也是在当前实验技术水平上可能实现的。他们还扩展了这一分析到N个离子，并预测冷却速率的线性增加随N而增加；在现有实验平台上，微粒的运动冷却可以减至零点几毫开尔文。该研究为探索置于陷阱中的微粒的非高斯动量态提供了理论工具集。


<details>
  <summary>Details</summary>
Motivation: 该论文涉及微粒和离子在陷阱中的量子动力学问题，目的是开发一种理论工具，以利用离子辅助准备小粒子的非高斯态。

Method: 他们首先推导了微粒和离子的动频率和经典轨迹，并进行了量子理论推导以计算相互作用情况下的冷却效果。

Result: 在现有的实验水平下，即使没有运动反馈或存在微运，微粒的运动冷却到亚开尔温温是可能的；并且当离子数量N增加时，冷却率会线性增加。利用N=现有，微粒的运动冷却可达0.几毫开尔温。

Conclusion: 该理论研究为利用离子辅助方法，精确控制和冷到小粒子的运动提供了方法和可能性。这在量子信息存储和微粒操控中有潜在的应用。
...
### [96] [Closed-Loop Phase-Coherence Compensation for Superconducting Qubits Integrated Computational and Hardware Validation of the Aurora Method](https://arxiv.org/abs/2511.20741)
*Futoshi Hamanoue*

Main category: quant-ph

TL;DR: 这项研究提出了Aurora-DD方法，通过结合递增式反馈和动态去耦技术，有效减少了量子位的相位漂移，实现了在超导量子星期机上的稳定硬件实现。


<details>
  <summary>Details</summary>
Motivation: 随着量子计算的发展，相位漂移已成为影响量子门性能的主要问题。寻找有效的相位补偿方法对于提高量子门的 fidelity至关重要。

Method: Aurora-DD方法通过使用标称反馈机制和固定深度的XY8动态去耦技术，设计了一个相位补偿方案。研究利用Aer模拟器进行了离线闭环优化，并在实际硬件（IBM Fezz）上进行了验证。

Result: 在模拟器上，Aurora-DD显著降低了<Z>的均方误差，特别是在各相位点的模拟结果均在68%-97%的范围内。在实际硬件上，通过3次测试，Aurora-DD的绝对误差减少了99.2%-99.6%，证明了其在实际量子星期机上的有效性。

Conclusion: Aurora-DD是一种有效地减少超导量子星期机中相位漂移的技术，并且能够在实际硬件上实现可靠的性能，为NISQ设备中的单一量子位校准提供了可靠的方法。
...
### [97] [Elucidating the Inter-system Crossing of the Nitrogen-Vacancy Center up to Megabar Pressures](https://arxiv.org/abs/2511.20750)
...
TL;DR: 研究了氮-v成iap中心在高压下的光学特性及其受压机制，建立了一个全面的理论框架，并解决了 Some关键问题。


<details>
  <summary>Details</summary>
Motivation: Quantum sensing在高压下的应用和材料科学中的氮-v中心特性研究。

Method: 利用第一性原理计算和高压实验结合的方法。

Result: 揭示了压力对氮-v中心光子特性的复杂影响，包括跨缺陷交叉率的变化，并解释了观察到的现象。

Conclusion: 建立了一个完整的理论框架，用于设计高性能的高压氮-v传感器，并证明了破坏缺陷对称性的压力可以作为调节固态自旋缺陷的新型手段。
...
### [98] [Nonreciprocal quantum information processing with superconducting diodes in circuit quantum electrodynamics](https://arxiv.org/abs/2511.20758)
*Nicolas Dirnegger,Prineha Narang,Arpit Arora*

Main category: quant-ph

TL;DR: This paper proposes the use of superconducting diodes (SDs) as coherent nonreciprocal elements in quantum computing hardware, leveraging their tunable behavior across devices to achieve nonreciprocal qubit couplings. The proposed circuit elements allow for high-fidelity signal routing and entanglement generation in microwave quantum networks.


<details>
  <summary>Details</summary>
Motivation: The growing demand for scalable, high-performance quantum computing hardware necessitates the development of advanced circuit elements that can implement nonreciprocal operations, which are essential for coherent control in quantum technologies.

Method: The authors propose the use of an asymmetric SQUID modulated by a flux bias as a controllable, nonlinear diode element. They implement a spectroscopic characterization of the diode's response and demonstrate its use in creating coherent nonreciprocal qubit couplings in a minimal two-qubit system.

Result: The results include the experimental demonstration of a nonreciprocal half-iSWAP gate with tunable Bell-state generation, showcasing the potential for embedded nonreciprocity in quantum control at the device level. The developed circuit elements are characterized across device hierarchies, enabling high-fidelity signal routing and entanglement generation in all-to-all connected microwave quantum networks.

Conclusion: The paper highlights the critical role of photonics and circuit elements in advancing quantum computing hardware. The introduction of tunable diode elements could pave the way for high-fidelity, scalable quantum processing architectures combining coherent control with nonlinear, nonreciprocal functionality.
...
### [99] [Multi-Field Relativistic Continuous Matrix Product States](https://arxiv.org/abs/2511.20762)
*Karan Tiwana,Antoine Tilloy*

Main category: quant-ph

TL;DR: RCMPS 变分 ansatz 对单一场量子场论是强大的，但多场时除非满足正则性条件，否则会发散。我们引入了黎曼优化框架，最小化多场 RCMPS 的能隙密度，并证明了其在二维和二维相互作用标量模型中的有效性和捕捉相变的能力。


<details>
  <summary>Details</summary>
Motivation: 研究量子场论中多场情况下的变分方法，提升 RCMPS 的适用性。

Method: 使用黎曼优化框架最小化多场 RCMPS 的能隙密度，自动满足正则性条件。

Result: 捕捉了对称性破缺相和 BKT 转变，扩展了 RCMPS 的应用范围。

Conclusion: 提供了一种新方法，允许更广泛的量子场论变分研究。
...
### [100] [Cost-effective scalable quantum error mitigation for tiled Ansätze](https://arxiv.org/abs/2511.21236)
...
TL;DR: 该论文提出了一种低成本的量子错误消除方法，基于最近的M0方法，通过利用堆叠Ansatz的局部性来显著减少量子处理器对误差表征的成本。实验结果表明，该方法在模拟和实际量子实验中都表现出优异性能，仅失真一点精度。


<details>
  <summary>Details</summary>
Motivation: 随着量子计算的快速发展，如何有效地减少和纠正量子错误变得至关重要。需要一种低成本且高效的方法来改进量子错误消除技术，以适应当前较慢的量子处理器速度和较低的量子位数量。

Method: 该方法通过结合M0方法和堆叠型Ansatz的局部性，提出了瓷砖M0方法。利用堆叠型Ansatz的结构，对M0方法进行了局部近似，从而实现了对量子处理器硬件成本的指数级减少。

Result: 在对分子基态能量计算的实验中，该方法在LiH、H₂、H₂O、butadiene和benzene（4-12 qubits）上进行了验证，证明了与M0方法相比，该方法在噪声模拟中几乎没有精度损失。同时，还在量子实验中展示了其在近-term应用中的潜力。

Conclusion: 该研究表明，瓷砖M0方法能够有效减少量子处理器对错误表征的成本，同时保持了与传统M0方法相当的精度。这为提升量子计算的性能和实用性提供了新思路。
...
### [101] [Rapid ground state energy estimation with a Sparse Pauli Dynamics-enabled Variational Double Bracket Flow](https://arxiv.org/abs/2511.21651)
*Chinmay Shrikhande,Arnab Bachhar,Aaron Rodriguez Jimenez,Nicholas J. Mayhall*

Main category: quant-ph

TL;DR: A variational double bracket flow algorithm accurately estimates ground state energies with high efficiency, outperforming DMRG benchmarks even on large systems.


<details>
  <summary>Details</summary>
Motivation: The paper addresses the challenge of estimating ground state energies for strongly correlated quantum systems, emphasizing the limitations of DMRG in higher dimensions and introducing new methods to overcome these obstacles.

Method: The algorithm combines greedy operator selection, coefficient truncation, and energy-variance extrapolation using Sparse Pauli Dynamics, originally developed for simulating quantum circuits.

Result: The vDBF method achieves less than 1% error relative to DMRG benchmarks and efficiently handles significantly larger systems (e.g., 10x10 Heisenberg lattice) by reducing computational time.

Conclusion: The paper opens new avenues for applying classical simulation techniques in practical many-body physics problems, leveraging insights from quantum advantage benchmarking
...
### [102] [Opportunities and Challenges of Computational Electromagnetics Methods for Superconducting Circuit Quantum Device Modeling: A Practical Review](https://arxiv.org/abs/2511.20774)
...
### [103] [Higher-order Zeno sequences](https://arxiv.org/abs/2511.20792)
*Kasra Rajabzadeh Dizaji,Leeseok Kim,Milad Marvian,Christian Arenz*

Main category: quant-ph

TL;DR: 该论文提出了高阶量子 Zeno 序列，通过关系到高阶塔特罗公式，实现了更快的 Zeno 动态收敛，错误阶数从 $	frac{1}{N}$ 提高到 $	frac{1}{N^{2k}}$。此外，作者还通过高频控制场和随机化/乌里格动态去耦等方法优化了 Zeno 动态的实现。


<details>
  <summary>Details</summary>
Motivation: 量子 Zeno 效应是量子力学中的一个基础且有趣的现象，其在量子信息科学中有广泛的应用。为了更有效地实现和控制 Zeno 动态，研究者提出了高阶 Zeno 序列。

Method: 作者借助于高阶塔特罗公式，将高阶 Zeno 序列与塔特罗公式建立了联系，进而实现更快的收敛速度。此外，作者还通过高频控制场和随机化/乌里格动态去耦的方法进一步优化了实现效率。

Result: 研究发现了能够将 Zeno 错误的阶数从 $	frac{1}{N}$ 提高到 $	frac{1}{N^{2k}}$ 的高阶 Zeno 序列。该方法适用于不同形式的量子 Zeno 效应，包括频繁的投影测量和单位 kick 操作。此外，作者还提出了通过高频控制场获得二阶改进的控制场。

Conclusion: 该研究为实现高效的 Zeno 动态提供了一种创新的方法，通过引入高阶 Zeno 序列和高频控制场等技术，显著提升了 Zeno 现象的实现效果。该成果在量子信息处理和量子控制等领域具有潜在的应用前景。
...
### [104] [Many-Body Entanglement in Solid-State Emitters](https://arxiv.org/abs/2511.20797)
...
TL;DR: This paper reviews the preparation and control of quantum states in solid-state quantum emitters and nanophotonics, highlighting recent advances in many-body interactions and coherence while addressing challenges from inhomogeneities and decoherence.


<details>
  <summary>Details</summary>
Motivation: It's a comprehensive review paper focusing on the state-of-the-art progress in solid-state quantum photonics, emphasizing the engineering of many-body interactions and coherence for quantum applications.

Method: The paper presents a systematic review, discussing theoretical models, experimental techniques, and applications of solid-state quantum states. The authors analyze recent experimental results and theoretical advances, identifying key challenges and potential solutions.

Result: The paper provides a detailed summary of recent experimental results in solid-state quantum emitters and their applications in quantum computing, sensing, and simulation. It also discusses theoretical models for many-body interactions and coherence control.

Conclusion: It concludes by outlining future directions for research in solid-state quantum photonics, emphasizing the challenges of managing decoherence and inhomogeneities while leveraging many-body entanglement for quantum technologies
...
### [105] [Nonextensive statistics for a 2D electron gas in noncommutative spaces](https://arxiv.org/abs/2511.20822)
*Bienvenu Gnim Adewi,Isiaka Aremua*

Main category: quant-ph

TL;DR: 研究了一个二维非交换空间中的量子系统，分析了其在Tsallis统计下的热力学性质，结合非交换几何的影响，揭示了其新的热力学行为和异常电磁特性。


<details>
  <summary>Details</summary>
Motivation: 研究非交换空间中的量子系统及其热力学性质在当前物理和数学领域的热点问题。

Method: 通过应用Tsallis统计和非交换几何，推导出广义的热力学量如配分函数、磁化率和磁 susceptibility。

Result: 发现了随着非交换参数θ和Tsallis参数q的变化，系统表现出新的热力学行为和例外的电磁特性。

Conclusion: 非交换空间中的量子系统在其热力学行为和电磁特性上展现出与经典理论不同的新特征。
...
### [106] [Mode multiplexing for scalable cavity-enhanced operations in neutral-atom arrays](https://arxiv.org/abs/2511.20858)
*Ziv Aqua,Matthew L. Peters,David C. Spierings,Guoqing Wang,Edita Bytyqi,Thomas Propson,Vladan Vuletić*

Main category: quant-ph

TL;DR: The paper discusses the challenge of photon collection in large-scale neutral atom arrays and proposes a cavity-based approach that enables fast, parallel operations. The approach leverages multiple cavity modes for multiplexed atomic processing, resulting in rapid mid-circuit syndrome extraction and improved entanglement distribution rates. This offers a scalable solution for advancing quantum technologies.


<details>
  <summary>Details</summary>
Motivation: Achieving scalability and high efficiency in quantum information processing systems is essential for advancing practical quantum technologies.

Method: The proposed method uses a cavity-based approach with multiple cavity modes to enable rapid and parallel atomic processing by shifting atomic transitions to distinct cavity modes, allowing simultaneous processing of multiple atoms. The design supports cavity-mode multiplexing up to 50 modes, enabling rapid mid-circuit syndrome extraction and significant enhancements in entanglement distribution rates.

Result: The proposed cavity-based approach achieves rapid mid-circuit syndrome extraction and significantly enhances entanglement distribution rates between remote atom arrays, offering a scalable solution to the bottleneck of photon collection in large-scale arrays.

Conclusion: This work provides a promising solution to the photon collection bottleneck in large-scale neutral atom arrays, paving the way for scalable and efficient quantum information processing systems.
...
### [107] [Restoring a Missing Meta-Symmetry of Quantum Mechanics](https://arxiv.org/abs/2511.20907)
*Sheng Ran*

Main category: quant-ph

TL;DR: 该研究通过扩展Hilbert空间，引入了动量-能量自伴算子，揭示了双流形对称性，解释了暗能量和 Hawking 辐射。


<details>
  <summary>Details</summary>
Motivation: 探索量子力学是否能在更广泛的空间框架下描述更多物理现象。

Method: 扩展Hilbert空间到H_total = H_xt ⊕ H_kE，并引入自伴算子T̂生成动量-能量的自主进化。

Result: 发现了双流形对称性，能够解释暗能量背景和靠近黑洞的辐射现象。

Conclusion: 该理论为描绘更多量子现象提供了新途径，并在量子力学和广义相对论之间架设桥梁。
...
### [108] [Fusion of classical and quantum kernels enables accurate and robust two-sample tests](https://arxiv.org/abs/2511.20941)
*Yu Terada,Yugo Ogio,Ken Arai,Hiroyuki Tezuka,Yu Tanaka*

Main category: quant-ph

TL;DR: 提出了基于量子核的混合测试策略，通过结合经典和量子核，提高了小样本和高维数据下的测试效能。


<details>
  <summary>Details</summary>
Motivation: 随着数据科学和机器学习的快速发展，小样本数据分析成为重要挑战，传统的核方法在选核方面存在不足，而量子核的引入为解决这一问题提供了新思路。

Method: 提出了混合测试框架MMD-FUSE，结合经典核和量子核，通过融合核特征，提升测试效果。

Result: 在多个模拟和实际临床数据集上，混合框架在小样本和高维数据下显著提高了测试效能，证明了量子核在小样本场景下的优越性。

Conclusion: 该研究展示了量子核方法在小样本数据分析中的潜力，为 Future 的小样本统计测试提供了新方法。
...
### [109] [Generalized Heralded Generation of Non-Gaussian States Using an Optical Parametric Amplifier](https://arxiv.org/abs/2511.20946)
*Xiao-Xi Yao,Bo Zhang Yusuf Turek*

Main category: quant-ph

TL;DR: 该论文提出了一种广义的有 herald 的光学参数放大器（OPA）协议，使其可以接受任意非经典输入，扩展了量子现象的研究范围，实现了从单一 setups 的专门用途到通用设备的转变。


<details>
  <summary>Details</summary>
Motivation: 量子态工程是一个快速发展的领域，现有的光学参数放大器在处理相干态输入方面有一定限制。为了克服这些限制并扩展其应用范围，该研究提出了一种广义的协议。

Method: 本论文通过引入广义的有 herald 的 OPA 协议，可以接受任意非经典输入，如被输入的高斯态混合体，从而实现了对不同量子态的处理。

Result: 1. 通过使用被压缩的空度真空输入，放大器充当了一个集成的两光子减数器，可以确定性地生成高质量、幅度较大的压缩态薛定谔猫态。2. 输入少量的薛定谔猫态时，协议可以进一步提高非高斯性，形成高质量的量子资源。

Conclusion: 这种协议将有 herald 的 OPA 从一种专门的量子源转变为一个通用的集成平台，可为量子态工程提供更灵活和实用的解决方案。
...
### [110] [Compilation Pipeline for Predicting Algorithmic Break-Even in an Early-Fault-Tolerant Surface Code Architecture](https://arxiv.org/abs/2511.20947)
...
### [111] [Mirror subspace diagonalization: a quantum Krylov algorithm with near-optimal sampling cost](https://arxiv.org/abs/2511.20998)
*Shota Kanasugi,Yuya O. Nakagawa,Norifumi Matsumoto,Yuichiro Hidaka,Kazunori Maruyama,Hirotaka Oshima*

Main category: quant-ph

TL;DR: Mirror subspace diagonalization (MSD) significantly reduces the sampling cost of quantum Krylov algorithms for ground-state energy estimation.


<details>
  <summary>Details</summary>
Motivation: The paper addresses the challenge of high sampling cost in quantum Krylov algorithms, which limits their practicality for large-scale electronic structure problems. By introducing MSD, a method that minimizes sampling overhead while maintaining accuracy, the authors aim to enhance the efficiency of these algorithms for real-world applications in quantum computing.

Method: MSD leverages a finite-difference formula to express the Hamiltonian operator as a linear combination of time-evolution unitaries with symmetrically shifted timesteps. The method optimizes the timestep parameter and shifts the energy spectrum to simultaneously minimize finite difference and statistical errors, achieving near-optimal sampling cost.

Result: MSD attains the theoretical lower bound of the sampling cost of quantum Krylov algorithms up to a logarithmic factor. It enables significant sampling cost reductions, particularly in scenarios where the spectral norm of the Hamiltonian is much smaller than its 1-norm, such as in high-accuracy simulations using large basis sets with strong electronic correlations. Numerical results demonstrate sampling cost reductions from approximately 10 to 10,000 times compared to conventional quantum Krylov algorithms.

Conclusion: The introduction of MSD represents a substantial advancement in optimizing quantum Krylov algorithms, offering a practical solution to the inherent sampling challenges and paving the way for more efficient and accurate quantum computations for large-scale electronic structure problems.
...
### [112] [Multi-path vector entanglement engineering via dark mode control in optomechanics](https://arxiv.org/abs/2511.21052)
*P. Djorwé,R. Altuijri,A. J. Almalki,S. Abdel-Khalek,A. -H. Abdel-Aty*

Main category: quant-ph

TL;DR: 研究提出了一种在光力机械系统中生成多条路径纠缠的方式，通过使用极化光场和暗态控制，结合两个机械耦合的谐波振荡器，在共同激发下实现了双态或三态纠缠。


<details>
  <summary>Details</summary>
Motivation: 随着量子信息处理和通信的需求日益增加，量子纠缠成为了关键基础资源。本研究试图探讨如何在光力机械系统中生成稳定且耐受噪声的纠缠态，以满足现代量子技术的需求。

Method: 研究通过在光力机械系统中引入极化光场和暗态控制，将两个机械振荡器通过共同激发连接，并利用机械耦合强度的变化来调节和控制纠缠态的生成。

Result: 成功实现了双态或三态纠缠，且在暗态破坏（DMB）条件下，纠缠资源更加稳定和耐受噪声。

Conclusion: 该方法为量子信息处理、量子通信和量子计算提供了新的资源和策略，特别在耐受噪声和高可靠性方面表现出色。
...
### [113] [Witness wedges in fidelity-deviation plane: separating teleportation advantage and Bell-inequality violation](https://arxiv.org/abs/2511.21079)
*Kyoungho Cho,Jeongho Bang*

Main category: quant-ph

TL;DR: 该论文提出了一种统一框架，通过平均信度和信度偏差两个指标对d维量子传态进行分析，揭示了高阶矩Haar平均在任意维度下的闭式表达式，并通过示意图展示了其应用潜力。


<details>
  <summary>Details</summary>
Motivation: 研究量子传态在高维度中的表现及其与信度相关的度量具有重要的理论和实验意义。

Method: 论文采用了表示论的方法，基于舒尔-韦尔对偶和排列对称性计算，将高阶矩Haar平均简化为有限迹不变量的组合。

Result: 结果给出了平均信度和信度偏差的闭式表达式，在任意维度下均成立，并提出了一个新的度量指标（(F, D)平面）来评估量子资源的非局域性。

Conclusion: 该研究为量子传态的优化与评估提供了理论框架，有助于更深入的理解量子信息的处理能力。
...
### [114] [Tip-enhanced quantum-sensing spectroscopy for bright and reconfigurable solid-state single-photon emitters](https://arxiv.org/abs/2511.21127)
*Hyeongwoo Lee,Taeyoung Moon,Hyeonmin Oh,Kijeong Park,Huitae Joo,Milos Toth,Igor Aharonovich,Kyoung-Duck Park*

Main category: quant-ph

TL;DR: Hexagonal boron nitride (hBN) atom-like defects are promising for room-temperature single-photon emission and coherent spin-state generation, but their random characteristics limit their use as bright single-photon sources and quantum sensors. This paper presents a tip-enhanced quantum-sensing method using single-photon emitters in hBN. By spatially positioning individual emitters within tip-cavities with different plasmon resonances, the researchers adaptively control the emission and excitation rates, as well as the single-photon purity. This approach allows for optimal reconfiguration of solid-state single-photon sources and enables both space- and time-resolved analyses. Additionally, the study demonstrates tip-enhanced quantum-sensing using single spin defects in hBN nanoflakes through optically detected magnetic resonance experiments, providing a pathway for highly-sensitive and deterministic quantum-sensing with room-temperature single-photon emitters.


<details>
  <summary>Details</summary>
Motivation: The motivation behind this research is to overcome the limitations of hBN atom-like defects in terms of their use as bright single-photon sources and quantum sensors. By leveraging quantum-sensing techniques and precise spatial positioning, the researchers aim to enhance the efficiency and reliability of hBN-based devices for quantum computing and sensing applications.

Method: The method described in the paper involves using tip-cavities in optical fibers to spatially position individual hBN defects. The researchers measure the emission and excitation rates and single-photon purity by analyzing the light output from these defects. Additionally, they use optically detected magnetic resonance (ODMR) experiments to study single spin defects in hBN nanoflakes, demonstrating the sensing capabilities of their approach.

Result: The key results show that the researchers successfully demonstrated tip-enhanced quantum-sensing of single-photon emitters in hBN. By adaptively controlling the emission and excitation rates, they achieved high single-photon purity and optimal reconfiguration of their sources. Furthermore, the ODMR experiments confirmed the ability to sense single spin defects with high sensitivity, highlighting the potential for deterministic quantum-sensing applications.

Conclusion: This work represents a significant advancement in the development of highly-sensitive and deterministic quantum-sensing devices using room-temperature single-photon emitters based on hBN. The researchers' approach opens new possibilities for integrating hBN defects into quantum computing and sensing systems, potentially leading to novel applications in these fields.
...
### [115] [Vortex-Enhanced Zitterbewegung in Relativistic Electron Wave Packets](https://arxiv.org/abs/2511.21142)
*Zhongze Guo,Bei Xu,Qiang Gu*

Main category: quant-ph

TL;DR: 研究提出了一种通过引入轨道角动量增强Zitterbewegung振幅的系综方法，构建了具有旋度的电子波包，有望观测到相对论量子动力学现象。


<details>
  <summary>Details</summary>
Motivation: 探索Zitterbewegung（ trembling运动）在电子中的观测可能性及其在相对论量子动力学中的应用。

Method: 构建了带有正负态Dirac态的相对论旋度电子包系综，分析其时空动力学行为。

Result: 通过引入轨道角动量显著增强了ZBW振幅，实现了与高斯包和贝塞尔高斯模型结合的统一框架，为ZBW的观测提供了新途径。

Conclusion: 该研究为理解Zitterbewegung在生态系统中的作用及其实验观测提供了理论基础，扩展了相对论量子动力学的理论框架。
...
### [116] [Geometric Entanglement Entropy on Projective Hilbert Space](https://arxiv.org/abs/2511.21186)
*Loris Di Cairano*

Main category: quant-ph

TL;DR: 这篇论文提出了一个几何框架来研究纯态之间的量子纠缠，利用Fubini-Study度量将纯态空间转化为黎曼流形，并定义了基于函数位的几何纠缠熵作为常数纠缠的流形体积。


<details>
  <summary>Details</summary>
Motivation: 研究几何意义上的纠缠结构及其在量子力学中的意义与应用。

Method: 将纯态空间赋予Fubini-Study度量，并通过函数分析确定了恒定纠缠的流形，计算了这些流形的体积作为几何纠缠熵。

Result: 定义了几何纠缠熵，并展示了在单自旋-1/2和两自旋系统的应用中取得进展。

Conclusion: 几何纠缠熵为研究量子纠缠的整体结构提供了一种新的视角，有助于理解纠缠的分布和度量。
...
### [117] [Tunable WS$_2$ Micro-Dome Open Cavity Single Photon Source](https://arxiv.org/abs/2511.21630)
...
TL;DR: 该论文提出了一种基于WS2微圆顶的单光子源，通过氢离子 irradiation制造，并将其集成到开式可调光微腔中，实现实时单光子发射。通过二阶相关测量，得到了g^(2)(τ=0)=0.3的结果。研究发现，声学 phonon emission sidebands显著影响了非谐振区的发射特性。该系统的发射调节能力表明，开式微腔系统可能成为调节二维量子发射器特性的理想平台，对量子技术应用具有潜在价值。


<details>
  <summary>Details</summary>
Motivation: 近年来，二维材料在量子技术中的应用得到了广泛研究。开发可调节和高效的一光源源对于量子光子学技术的发展至关重要。

Method: 在实验中，研究人员使用氢离子 irradiation在WS2上制备微圆顶结构，并将其嵌入开式可调光微腔系统中。通过测量和分析二阶相关性以及光谱特征，特别是声学phonon emission sidebands的影响。

Result: 实验结果表明，该系统的单光子发射特性受到明显声学phonon emission sidebands的影响，达到了良好的发射调控效果，g^(2)(τ=0)=0.3证实了良好的非谐振区发射性能。

Conclusion: 该研究展示了开式微腔系统在调控二维量子发射器方面的能力，为量子光子学技术提供了新的实现途径。
...
### [118] [Phase-Dependent Photon Emission Rates in Quantum Gravity-Induced Entangled States](https://arxiv.org/abs/2511.21392)
*Chi Zhang*
...
### [119] [Phase Estimation with Compressed Controlled Time Evolution](https://arxiv.org/abs/2511.21225)
*Erenay Karacan*
...
### [120] [The effects of decoherence on Fermi's golden rule](https://arxiv.org/abs/2511.21238)
*Caihong Zheng,Fan Zheng*

Main category: quant-ph

TL;DR: 文章探讨了量子相干性对费米黄金法则的影响，发现当相干性较强时，固定基底和可近似基底的费米黄金法则会有显著偏差。通过WS2单层材料的实例研究了电子-声子耦合引起的载流子迁移示踪实验中的相干效应。


<details>
  <summary>Details</summary>
Motivation: 随着量子计算和超快载流子动力学的发展，相干性已成为基础研究中的重要课题。因此，研究相干性对费米黄金法则的影响具有重要的理论和应用价值。

Method: 采用非绝ظ分子动力学方法，结合第一性原理计算，分别研究固定基底和可近似基底下的相干效应。

Result: 当相干时间较短时，固定基底和可近似基底的费米黄金法则与原理论结果显著偏差。通过WS2单层材料的具体计算，验证了相干效应对载流子迁移示踪实验的显著影响。

Conclusion: 相干性对费米黄金法则的适用性有重要挑战，未来研究应更全面地考虑量子相干效应。
...
### [121] [Factorisation conditions and causality for local measurements in QFT](https://arxiv.org/abs/2511.21644)
...
### [122] [Finite-key security analysis of the decoy-state BB84 QKD with passive measurement](https://arxiv.org/abs/2511.21253)
*Akihiro Mizutani,Shun Kawakami,Go Kato*

Main category: quant-ph

TL;DR: _passive measurement in decoy-state BB84 QKD doesn't significantly affect key generation efficiency.


<details>
  <summary>Details</summary>
Motivation: Improving QKD systems' practicality by reducing complex components.

Method: Finite-key analysis for decoy-state BB84 with passive basis choice.

Result: Key rates for passive and active measurement are nearly the same, so passive measurement is efficient enough.

Conclusion: Passive measurement in decoy-state BB84 QKD is practical and doesn't compromise key generation.
...
### [123] [Holographically Emergent Gauge Theory in Symmetric Quantum Circuits](https://arxiv.org/abs/2511.21685)
...
### [124] [The Quantum Agreement Theorem](https://arxiv.org/abs/2511.21258)
*María García Díaz,Adam Brandenburger,Giannicola Scarpa*

Main category: quant-ph

TL;DR: 该摘要讨论了量子力学中两个实验室（代表不同观察者）在共享量子属性上保持一致概率估计的条件，分析了量子力学中的共识和不一致现象。


<details>
  <summary>Details</summary>
Motivation: 研究者旨在探讨量子力学中不同观察者如何保持一致的概率估计，这在量子力学的多Observers问题中具有重要意义。

Method: 研究通过构建一个量子力学的共识框架，利用Aumann的古典共识理论和多arget operators的方法，分析了量子力学中的共识和不一致现象。

Result: 研究发现量子力学允许这种情况：观察者可以确信对方不确信该属性的存在，这与古典理论中的共识情况不同。

Conclusion: 研究结果为理解量子力学中的多身体共识提供了一种新的视角，并有助于填补量子哲学中的知识空白。
...
TL;DR: The paper discusses the generalised Born rule in modern compositional approaches to quantum theory, arguing that probabilities can be derived from state and effect composition. It shows that the postulate of the Born rule can be derived from basic principles and explores the role of noise in strengthening the connection between scalars and probabilities.


<details>
  <summary>Details</summary>
Motivation: The paper aims to understand the foundational principles behind the Born rule and how it can be derived from basic assumptions in quantum theory.

Method: The authors use a process-theoretic approach, starting with a naive interpretation of quantum theory and gradually introducing more structure to demonstrate the emergence of the Born rule.

Result: The authors conclude that the Born rule can be derived from basic principles and that introducing noise strengthens the relationship between probabilities and scalars.

Conclusion: The paper provides a new perspective on the foundations of quantum theory, showing how key principles like the Born rule can emerge from simple assumptions.
...
TL;DR: 研究了光电子自旋与X射线极化光子自旋之间在钛氧化物和铈氟化合物中的量子纠缠，发现两种机制：一种是2p内层电子的自旋-轨道相互作用导致的，另一种是4f价电子的自旋-轨道相互作用与4f和4d电子之间 strong 交换作用导致的。然而在3d→3p过程中由于 crystal field效应，没有产生纠缠。


<details>
  <summary>Details</summary>
Motivation: 自旋和极化在X射线光电子能谱极化中具有重要意义，揭示其相互关系对量子纠缠过程的影响具有重要意义。

Method: 使用了ousesTiO6结构模型和离子模型分别对两种化合物系统的能谱极化X射线极化光子自旋-轨道相互作用进行了理论计算。

Result: 在3d→2p和4f→4d过程中，纠缠的生成机制不同，分别为(a) 2p内层自旋-轨道作用。(b) 4f价电子自旋-轨道作用与4f和4d电子的 strong 交换作用。在3d→3p过程中，由于 crystal field效应，没有产生纠缠。

Conclusion: 文中详细分析了不同内层激发过程中的自旋-极化物纠缠机制，发现其不同，为理解基于自旋的光电子能谱极化特性提供了理论依据。
...
### [128] [Quantum electrodynamic description of the neutral hydrogen molecule ionization](https://arxiv.org/abs/2511.21430)
*Hui-hui Miao*

Main category: quant-ph

TL;DR: 研究氢分子的离解动力学，提出了一种结合量子电动力学和林德布德主方程的统一框架，分析了不同量子状态下系统的动力学行为，揭示了离子化概率的上限及其对初始量子态的敏感性。


<details>
  <summary>Details</summary>
Motivation: 探索氢分子的离解动力学对于量子化学和量子信息处理的重要意义，尤其是在量子电动力学框架下的行为。

Method: 通过结合量子电动力学和林德布德主方程，系统地研究了封闭量子系统、开放量子系统以及带入粒子激发的开放量子系统。

Result: 氢分子形成了中性状态，离解概率的上限为3/4，初始量子态显著影响离解路径，离解率受入射光子数和能级分配控制。

Conclusion: 统一的量子理论框架解释了氢分子的离解现象，为量子控制化学和量子信息技术提供了理论基础。
...
### [129] [Quantum Analytical Mechanics: Quantum Mechanics with Hidden Variables](https://arxiv.org/abs/2511.21435)
*Wolfgang Paul*
...
### [130] [Magic spreading under unitary Clifford dynamics](https://arxiv.org/abs/2511.21487)
...
### [131] [Modeling dissipation in quantum active matter](https://arxiv.org/abs/2511.21502)
...
TL;DR: 研究者探讨了在量子框架下描述活性物质的必要方法，通过研究不同形式的时间局域 master equations 的动力学，揭示了量子效应如何与活性动力学相互作用以影响粒子运动。


<details>
  <summary>Details</summary>
Motivation: 通过在量子框架下研究活性物质，研究者为实验实现量子类活系统提供了指导。

Method: 研究者使用时间局域的 master equations 作为模型，并对不同形式的 master equations 进行动态研究，比较了不同 master equations 的结果。

Result: 计算结果显示，量子效应与活性动力学的相互作用显著影响了粒子运动，需要根据不同的 master equations 形式选择合适的实验设计。

Conclusion: 这项研究为实验实现量子类活系统提供了重要指导。
...
TL;DR: The paper investigates the stability of the superradiant phase in the dissipative quantum Rabi model under weak spin relaxation. A weak spin relaxation can cause the superradiant phase to become a metastable phase, where symmetry-breaking states are stable only for a finite time. The finite lifetime of these states is due to spin-jump induced by relaxation as strong perturbation driving the system from symmetry-breaking states to the symmetry-preserving saddle point with finite probability. The symmetry is restored in the steady state. The results are obtained by combining mean-field and cumulant expansion analyses with exact numerical simulations in finite-size systems and using finite-size scaling to extrapolate to the thermodynamic limit.


<details>
  <summary>Details</summary>
Motivation: The paper studies the stability of the superradiant phase in the dissipative quantum Rabi model under weak spin relaxation. The motivation is to understand how symmetry-breaking states are affected by weak spin relaxation in the presence of dissipation.

Method: The paper uses a combination of mean-field theory, cumulant expansion analysis, and exact numerical simulations. The lifetime of the symmetry-breaking states is analyzed in finite-size systems, and finite-size scaling is used to extrapolate to the thermodynamic limit.

Result: The paper shows that even a weak spin relaxation can lead to the superradiant phase becoming a metastable phase. The symmetry-breaking states are stable only for a finite time. The spin-jump induced by relaxation acts as a strong perturbation, potentially driving the system from a symmetry-breaking state to the symmetry-preserving saddle point with finite probability. In the steady state, the symmetry is restored.

Conclusion: The metastability of symmetry-breaking states in the dissipative quantum Rabi model is established. The findings reveal the complexity of the dissipative phase transition beyond their equilibrium counterpart. The mechanisms uncovered can be generalized to other open quantum systems, highlighting fundamental differences between equilibrium and steady-state phase transitions.
...
TL;DR: A hidden U(1) gauge interaction coupling to quantum coherence in macroscopic systems is proposed, with three signature predictions: interferometric phase shifts, decoherence rates, and entanglement forces. The theory maintains gauge invariance and can be tested with atom interferometers and nanoparticles.


<details>
  <summary>Details</summary>
Motivation: Exploring fundamental interactions mediated by quantum coherence is a cutting-edge area in quantum physics, seeking to understand the quantum-classical transition.

Method: The authors develop a theoretical framework by constructing a conserved coherence current operator derived from the Noether mass current using operator-level coarse-graining. This operator leads to predictions about phase shifts, decoherence, and entanglement forces, which can be experimentally tested with current technologies like atom interferometers.

Result: The paper identifies three observable phenomena: (i) phase shifts proportional to fringe visibility, (ii) decoherence with m² scaling, and (iii) entanglement-dependent forces. These results are derived while maintaining gauge invariance, causality, and positive time evolution.

Conclusion: This work opens a new avenue to probe coherence-induced fundamental interactions. By using atom interferometers and nanoparticles, the coupling strength can be experimentally constrained, offering a novel approach to study the quantum-to-classical bridge.
...
### [134] [The derivation of the Liouville equation from the Schrodinger equation and its implications](https://arxiv.org/abs/2511.21601)
*A. P. Meilakhs*

Main category: quant-ph

TL;DR: 一个可以从量子力学直接推导出经典力学的新方法被提出，该方法与量子态跃迁率的标准推导方法相容。该方法被用来推导物理动力学的主要公式。通过使用约尔当方程，非碰撞部分的玻尔兹曼方程可以被推导出来，而通过转移矩阵，碰撞积分也可以被推导出来。论文的最终成果是通过纯形式的数学操作从薛定谔方程推导出波尔兹曼方程，而无需将不同部分拼接的非严格合理推理。


<details>
  <summary>Details</summary>
Motivation: 从量子力学推导经典力学是一种长期而深刻的研究主题。这种方法不仅可以直接推导，而且在方法上与已有量子态跃迁率推导相容，为更深层次的理解提供了可能。

Method: 新方法直接从量子力学出发，利用约尔当方程的非碰撞部分，以及转移矩阵的碰撞积分，通过纯形式操作推导出波尔兹曼方程。

Result: 成功从薛定谔方程出发，通过纯数学操作，一次性推导出波尔兹曼方程，不需要拼接非严格推理。

Conclusion: 新方法简洁且严格，为推导经典力学提供了精确的方法。
...
### [135] [Lazy Quantum Walks with Native Multiqubit Gates](https://arxiv.org/abs/2511.21608)
...
### [136] [FPGA-tailored algorithms for real-time decoding of quantum LDPC codes](https://arxiv.org/abs/2511.21660)
*Satvik Maurya,Thilo Maurer,Markus Bühler,Drew Vandeth,Michael E. Beverland*

Main category: quant-ph

TL;DR: An FPGA-based decoder implementation for quantum error correction achieves high performance with a 98% success rate on testgate circuit simulations but may not be ready for large-scale integration.


<details>
  <summary>Details</summary>
Motivation:  developments in quantum computing require fault-tolerant error correction, with real-time decoding being essential

Method: FPGA implementation of three decoder classes for qLDPC codes: message passing, ordered statistics, and clustering. Performance analysis and optimization.

Result: The FPGA-based Message Passing decoding achieves a high success rate, 98% as measured on testgate circuit simulations under simulated noise conditions for standard decoding scenarios.

Conclusion: While FPGA-based qLDPC decoding shows promise, Message Passing achieves the best success rate and speed, necessitating further exploration for real-world quantum computing applications.
...
### [137] [Finite Size Analysis of Decoy-State BB84 with Advantage Distillation](https://arxiv.org/abs/2511.21665)
*Jonas Treplin,Philipp Kleinpaß,Davide Orsucci*

Main category: quant-ph

TL;DR: 通过 advantages distillation (AD) 处理，量子密钥分发 (QKD) 协议的最大可接受量子位错误率 (QBER) 得到了提高。


<details>
  <summary>Details</summary>
Motivation: 提高 QKD 协议的安全性和距离。”

Method: AD 是一种经典的后处理技术，通过后选择块的比特并提取高保真度的比特来增强 QKD 协议。

Result: 使用 AD 后，最大可接受的 QBER 从约 9.5% 提高到约 17.3%，特别适用于受最大可接受 QBER 影响的场景。

Conclusion: AD 提供了一种通过改进后处理方法来显著提高 QKD 性能的途径。
...
### [138] [Energy-efficient recurrence quantification analysis](https://arxiv.org/abs/2511.20684)
*Norbert Marwan*
...
### [139] [Thickness-Dependent Charge-Carrier Mobility in Home-Grown High-Purity Germanium Crystals](https://arxiv.org/abs/2511.20842)
...
TL;DR: 该论文研究了高纯锗片厚薄对载流子 mobility 影响，发现其遵循扩展指数关系，主要由静电去空穴效应引起，提供设计指南。


<details>
  <summary>Details</summary>
Motivation: 锗片用于辐射探测器、薄体制电子和量子设备，理解其载流子迁移率随厚度变化对优化重要。

Method: 通过 Hall 效应测量 n-型和 p-型锗片，从 2.7 mm 缩薄到 7 μm，研究其迁移率随厚度变化。建立扩展指数模型并与边界散射和去电模型对比。

Result: 迁移率遵循 μ(t) = μ0[1 - exp(-(t/τ)^β)]，主要由静电去空穴效应主导，锗片电场长度τ介于 6-50 μm。结果揭示静电去空穴效应和长程屏蔽是迁移率交叉的主要机制，提供设计指南：厚度 t ≥ 3τ 保持大部分 bulk mobility，t < 3τ 进入去电控制 regime。

Conclusion: 该研究首次系统性地研究锗片迁移率随厚度变化，并为锗基辐射探测器、薄体制电子和量子设备设计提供了重要参考。
...
### [140] [Electrically Pumped Terahertz Frequency Comb Based on Actively Mode-locked Resonant Tunneling Diode](https://arxiv.org/abs/2511.21100)
...
### [141] [Half-Vortex Polariton Condensate in a Topological BIC Metasurface](https://arxiv.org/abs/2511.21111)
...
### [142] [Fly-by transit: A novel door-to-door shared mobility with minimal stops](https://arxiv.org/abs/2511.21295)
*Wenbo Fan,Weihua Gu*

Main category: physics.app-ph

TL;DR: 这个论文提出来门对门共享 mobility 系统 fly-by transit (FBT)，使用模块化小电动车辆实现快速出行，相比现有模块化 minibus 概念，FBT 可行性更高。


<details>
  <summary>Details</summary>
Motivation: 共享 mobility 系统是解决城市交通拥堵和环境问题的重要途径，尤其是模块化设计可以提高系统的灵活性和扩展性。

Method: FBT 由低成本 trailer 和高性能 leader模块组成， trailer 独立运行以提供 feed 运输服务，而在 hubs 内部连接形成platoon以利用规模经济。尾部 trailer 可以不与主队列 coupling，实现不停顿运行。

Result: FBT 相对于传统公交车和网约车，显著减少了出行时间，并且运营成本更低。数值分析表明 FBT 在系统成本上有 13% 的节约。

Conclusion: FBT 是一种可行且可扩展的未来城市交通解决方案，值得进一步研究和推广。
...
### [143] [Vibrational Transportation of Deformable Axisymmetric Particles](https://arxiv.org/abs/2511.21528)
*Marina E. Terzi,Vladislav V. Aleshin,Jules Ghesqui`ere,Vincent Tournat*

Main category: physics.app-ph

TL;DR: 研究探讨了颗粒在表面声波激励下的横向漂移现象，揭示了基于Cattaneo-Mindlin力学的力模型对漂移机制的影响，并展示了动态加载条件下系统的复杂行为。


<details>
  <summary>Details</summary>
Motivation: 理解颗粒在声学激励下如何实现定向运动对众多应用领域具有重要理论和实践意义。

Method: 研究者采用Cattaneo-Mindlin力学模型和记忆图方法构建了力模型，分析了颗粒运动机理，并通过数值模拟验证了理论结果。

Result: 颗粒在测量范围内每次接触周期内有不同的进退效率，导致横向漂移。模型分析了不同加载条件下颗粒的动态行为，实验结果与理论一致。

Conclusion: 本文为最优条件下的定向运动提供了理论模型和实验依据，但仍需进一步研究不同干扰条件下的复杂行为。
...
### [144] [Thermomechanical model of solar cells](https://arxiv.org/abs/2511.21554)
*Tom Markvart*

Main category: physics.app-ph

TL;DR: 论文中将太阳电池视为一个机械式的开式热力循环发动机，通过电子-空穴对的热化过程产生化学势。在单日辐照下，光束扩展和电流产生描述为绝热损失功。更为一般地说，开放循环过程产生的电压对应于可用功，因此修正了Shk肯定是综合平衡极限。


<details>
  <summary>Details</summary>
Motivation: 该论文致力于探索太阳电池的极限效率，通过将太阳电池系统视为热力学系统的改进模型。

Method: 论文中使用了热力学模型来分析太阳电池系统，具体包括机械循环热力学引擎的分析方法，以及利用Shk修正模型来描述系统的效率。

Result: 论文提出了一种改进的Shk极限模型，能够更准确地描述太阳电池在开式循环过程中的效率限制和能力提升。

Conclusion: 研究结果表明，改进后的模型能够提供比Shk极限更准确的效率预测，为开发高效率太阳电池系统提供了新的理论依据。
